[node-taglib-sharp](../README.md) / [Exports](../modules.md) / Mpeg4IsoHandlerBox

# Class: Mpeg4IsoHandlerBox
...
- [boxType](Mpeg4IsoHandlerBox.md#boxtype)
- [data](Mpeg4IsoHandlerBox.md#data)
- [dataHandlerType](Mpeg4IsoHandlerBox.md#datahandlertype)
- [dataPosition](Mpeg4IsoHandlerBox.md#dataposition)
- [dataSize](Mpeg4IsoHandlerBox.md#datasize)
- [flags](Mpeg4IsoHandlerBox.md#flags)
- [handlerType](Mpeg4IsoHandlerBox.md#handlertype)
- [hasChildren](Mpeg4IsoHandlerBox.md#haschildren)
- [header](Mpeg4IsoHandlerBox.md#header)
- [name](Mpeg4IsoHandlerBox.md#name)
- [size](Mpeg4IsoHandlerBox.md#size)
- [version](Mpeg4IsoHandlerBox.md#version)

### Methods

- [addChild](Mpeg4IsoHandlerBox.md#addchild)
- [clearChildren](Mpeg4IsoHandlerBox.md#clearchildren)
- [getChild](Mpeg4IsoHandlerBox.md#getchild)
- [getChildRecursively](Mpeg4IsoHandlerBox.md#getchildrecursively)
- [getChildren](Mpeg4IsoHandlerBox.md#getchildren)
- [increaseDataPosition](Mpeg4IsoHandlerBox.md#increasedataposition)
- [initializeFromHeader](Mpeg4IsoHandlerBox.md#initializefromheader)
- [initializeFromHeaderFileAndHandler](Mpeg4IsoHandlerBox.md#initializefromheaderfileandhandler)
- [initializeFromType](Mpeg4IsoHandlerBox.md#initializefromtype)
- [initializeFromTypeVersionAndFlags](Mpeg4IsoHandlerBox.md#initializefromtypeversionandflags)
- [loadData](Mpeg4IsoHandlerBox.md#loaddata)
- [removeChildByBox](Mpeg4IsoHandlerBox.md#removechildbybox)
- [removeChildByType](Mpeg4IsoHandlerBox.md#removechildbytype)
- [removeChildrenByBox](Mpeg4IsoHandlerBox.md#removechildrenbybox)
- [fromFile](Mpeg4IsoHandlerBox.md#fromfile)
- [fromHandlerTypeAndHandlerName](Mpeg4IsoHandlerBox.md#fromhandlertypeandhandlername)
...
• `get` **dataHandlerType**(): [`ByteVector`](ByteVector.md)
...
▸ `Static` **fromFile**(`header`, `file`, `handlerType`): [`Mpeg4IsoHandlerBox`](Mpeg4IsoHandlerBox.md)

Constructs and initializes a new instance of IsoHandlerBox with a provided header and h
...
▸ `Static` **fromHandlerTypeAndHandlerName**(`handlerType`, `name`): [`Mpeg4IsoHandlerBox`](Mpeg4IsoHandlerBox.md)
...
| `name`        | `string`                      | An object specifying the handler name.                                 |
