[node-taglib-sharp](../README.md) / [Exports](../modules.md) / Mpeg4AppleAnnotationBox

# Class: Mpeg4AppleAnnotationBox

This class extends [Mpeg4Box](Mpeg4Box.md) to provide an implementation of an Apple AnnotationBox.
...
- [boxType](Mpeg4AppleAnnotationBox.md#boxtype)
- [data](Mpeg4AppleAnnotationBox.md#data)
- [dataPosition](Mpeg4AppleAnnotationBox.md#dataposition)
- [dataSize](Mpeg4AppleAnnotationBox.md#datasize)
- [handlerType](Mpeg4AppleAnnotationBox.md#handlertype)
- [hasChildren](Mpeg4AppleAnnotationBox.md#haschildren)
- [header](Mpeg4AppleAnnotationBox.md#header)
- [size](Mpeg4AppleAnnotationBox.md#size)

### Methods

- [addChild](Mpeg4AppleAnnotationBox.md#addchild)
- [clearChildren](Mpeg4AppleAnnotationBox.md#clearchildren)
- [getChild](Mpeg4AppleAnnotationBox.md#getchild)
- [getChildRecursively](Mpeg4AppleAnnotationBox.md#getchildrecursively)
- [getChildren](Mpeg4AppleAnnotationBox.md#getchildren)
- [increaseDataPosition](Mpeg4AppleAnnotationBox.md#increasedataposition)
- [initializeFromHeader](Mpeg4AppleAnnotationBox.md#initializefromheader)
- [initializeFromType](Mpeg4AppleAnnotationBox.md#initializefromtype)
- [loadData](Mpeg4AppleAnnotationBox.md#loaddata)
- [removeChildByBox](Mpeg4AppleAnnotationBox.md#removechildbybox)
- [removeChildByType](Mpeg4AppleAnnotationBox.md#removechildbytype)
- [removeChildrenByBox](Mpeg4AppleAnnotationBox.md#removechildrenbybox)
- [fromHeader](Mpeg4AppleAnnotationBox.md#fromheader)
- [fromType](Mpeg4AppleAnnotationBox.md#fromtype)
...
▸ `Static` **fromHeader**(`header`, `handlerType`): [`Mpeg4AppleAnnotationBox`](Mpeg4AppleAnnotationBox.md)

Constructs and initializes a new instance of AppleAnnotationBox with a provided header and
...
▸ `Static` **fromType**(`type`): [`Mpeg4AppleAnnotationBox`](Mpeg4AppleAnnotationBox.md)

Constructs and initializes a new instance of AppleAnnotationBox of specified type with no children.

#### Parameters

| Name   | Type                          | Description                                                        |
| :----- | :---------------------------- | :----------------------------------------------------------------- |
| `type` | [`ByteVector`](ByteVector.md) | A [ByteVector](ByteVector.md) object containing a 4-byte box type. |
