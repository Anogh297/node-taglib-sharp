[node-taglib-sharp](../README.md) / [Exports](../modules.md) / SandwichFile
...
- [`File`](File.md)
  ...
  ↳↳ [`MpegAudioFile`](MpegAudioFile.md)

  ↳↳ [`MpegContainerFile`](MpegContainerFile.md)
...
- [constructor](SandwichFile.md#constructor)

### Accessors

- [corruptionReasons](SandwichFile.md#corruptionreasons)
- [endTag](SandwichFile.md#endtag)
- [fileAbstraction](SandwichFile.md#fileabstraction)
- [hasTags](SandwichFile.md#hastags)
- [isPossiblyCorrupt](SandwichFile.md#ispossiblycorrupt)
- [isWritable](SandwichFile.md#iswritable)
- [length](SandwichFile.md#length)
- [mediaEndPosition](SandwichFile.md#mediaendposition)
- [mediaStartPosition](SandwichFile.md#mediastartposition)
- [mimeType](SandwichFile.md#mimetype)
- [mode](SandwichFile.md#mode)
- [name](SandwichFile.md#name)
- [position](SandwichFile.md#position)
- [properties](SandwichFile.md#properties)
- [startTag](SandwichFile.md#starttag)
- [tag](SandwichFile.md#tag)
- [tagTypes](SandwichFile.md#tagtypes)
- [tagTypesOnDisk](SandwichFile.md#tagtypesondisk)
- [bufferSize](SandwichFile.md#buffersize)

### Methods

- [dispose](SandwichFile.md#dispose)
- [find](SandwichFile.md#find)
- [getTag](SandwichFile.md#gettag)
- [insert](SandwichFile.md#insert)
- [markAsCorrupt](SandwichFile.md#markascorrupt)
- [preSave](SandwichFile.md#presave)
- [rFind](SandwichFile.md#rfind)
- [readBlock](SandwichFile.md#readblock)
- [readProperties](SandwichFile.md#readproperties)
- [removeBlock](SandwichFile.md#removeblock)
- [removeTags](SandwichFile.md#removetags)
- [save](SandwichFile.md#save)
- [seek](SandwichFile.md#seek)
- [truncate](SandwichFile.md#truncate)
- [writeBlock](SandwichFile.md#writeblock)
- [addFileType](SandwichFile.md#addfiletype)
- [addFileTypeResolver](SandwichFile.md#addfiletyperesolver)
- [createFromAbstraction](SandwichFile.md#createfromabstraction)
- [createFromPath](SandwichFile.md#createfrompath)
- [removeFileType](SandwichFile.md#removefiletype)
- [removeFileTypeResolver](SandwichFile.md#removefiletyperesolver)
...
| Name            | Type                          | Default value | Description                                                                                                      |
| :-------------- | :---------------------------- | :------------ | :--------------------------------------------------------------------------------------------------------------- |
| `pattern`       | [`ByteVector`](ByteVector.md) | `undefined`   | Pattern to search for in the current instance. Must be shorter than the [bufferSize](SandwichFile.md#buffersize) |
...
▸ `Protected` `Abstract` **readProperties**(`readStyle`): [`Properties`](Properties.md)
