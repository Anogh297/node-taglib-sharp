...
- [AIFF_FORM_TYPE](AiffFile.md#aiff_form_type)
- [COMM_IDENTIFIER](AiffFile.md#comm_identifier)
- [FILE_IDENTIFIER](AiffFile.md#file_identifier)
- [ID3_IDENTIFIER](AiffFile.md#id3_identifier)
- [SOUND_IDENTIFIER](AiffFile.md#sound_identifier)
...
| :---------------- | :------------------------------------------------------------------ | :------------------------------------------------------------------------------------------------------------- |
| `file`            | `string` \| [`IFileAbstraction`](../interfaces/IFileAbstraction.md) | File abstraction to use when reading and writing to the file                                                   |
| `propertiesStyle` | [`ReadStyle`](../enums/ReadStyle.md)                                | Level of accuracy to read the media properties, or [None](../enums/ReadStyle.md#none) to ignore the properties |
...
▪ `Static` `Readonly` **AIFF_FORM_TYPE**: [`ByteVector`](ByteVector.md)
...
▪ `Static` `Readonly` **COMM_IDENTIFIER**: [`ByteVector`](ByteVector.md)
...
▪ `Static` `Readonly` **ID3_IDENTIFIER**: [`ByteVector`](ByteVector.md)
...
▪ `Static` `Readonly` **SOUND_IDENTIFIER**: [`ByteVector`](ByteVector.md)
