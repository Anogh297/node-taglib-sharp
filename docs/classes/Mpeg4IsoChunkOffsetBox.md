[node-taglib-sharp](../README.md) / [Exports](../modules.md) / Mpeg4IsoChunkOffsetBox

# Class: Mpeg4IsoChunkOffsetBox

This class extends FullBox to provide an implementation of a ISO/IEC 14496-12 ChunkOffsetBox.
...
- [boxType](Mpeg4IsoChunkOffsetBox.md#boxtype)
- [data](Mpeg4IsoChunkOffsetBox.md#data)
- [dataPosition](Mpeg4IsoChunkOffsetBox.md#dataposition)
- [dataSize](Mpeg4IsoChunkOffsetBox.md#datasize)
- [flags](Mpeg4IsoChunkOffsetBox.md#flags)
- [handlerType](Mpeg4IsoChunkOffsetBox.md#handlertype)
- [hasChildren](Mpeg4IsoChunkOffsetBox.md#haschildren)
- [header](Mpeg4IsoChunkOffsetBox.md#header)
- [size](Mpeg4IsoChunkOffsetBox.md#size)
- [version](Mpeg4IsoChunkOffsetBox.md#version)

### Methods

- [addChild](Mpeg4IsoChunkOffsetBox.md#addchild)
- [clearChildren](Mpeg4IsoChunkOffsetBox.md#clearchildren)
- [getChild](Mpeg4IsoChunkOffsetBox.md#getchild)
- [getChildRecursively](Mpeg4IsoChunkOffsetBox.md#getchildrecursively)
- [getChildren](Mpeg4IsoChunkOffsetBox.md#getchildren)
- [increaseDataPosition](Mpeg4IsoChunkOffsetBox.md#increasedataposition)
- [initializeFromHeader](Mpeg4IsoChunkOffsetBox.md#initializefromheader)
- [initializeFromHeaderFileAndHandler](Mpeg4IsoChunkOffsetBox.md#initializefromheaderfileandhandler)
- [initializeFromType](Mpeg4IsoChunkOffsetBox.md#initializefromtype)
- [initializeFromTypeVersionAndFlags](Mpeg4IsoChunkOffsetBox.md#initializefromtypeversionandflags)
- [loadData](Mpeg4IsoChunkOffsetBox.md#loaddata)
- [removeChildByBox](Mpeg4IsoChunkOffsetBox.md#removechildbybox)
- [removeChildByType](Mpeg4IsoChunkOffsetBox.md#removechildbytype)
- [removeChildrenByBox](Mpeg4IsoChunkOffsetBox.md#removechildrenbybox)
- [fromFile](Mpeg4IsoChunkOffsetBox.md#fromfile)
...
▸ `Static` **fromFile**(`header`, `file`, `handlerType`): [`Mpeg4IsoChunkOffsetBox`](Mpeg4IsoChunkOffsetBox.md)

Constructs and initializes a new instance of IsoChunkOffsetBox with a provided header and
