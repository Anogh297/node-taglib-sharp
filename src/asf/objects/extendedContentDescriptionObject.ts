...
export class ExtendedContentDescriptionObject extends BaseObject {
	 ...
	 */
	public get descriptors(): ContentDescriptor[] {
	...
	public get isEmpty(): boolean {
		return this._descriptors.length === 0;
	}

	/** @inheritDoc */
	public get objectType(): ObjectType {
		return ObjectType.ExtendedContentDescriptionObject;
	}
	...
	/** @inheritDoc */
	public render(): ByteVector {
		const output = ByteVector.concatenate(ReadWriteUtils.renderWord(this._descriptors.length), ...this._descriptors.map((r) => r.render()));
