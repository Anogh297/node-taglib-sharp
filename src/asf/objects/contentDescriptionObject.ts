...
export default class ContentDescriptionObject extends BaseObject {
	...
	public get copyright(): string {
		return this._copyright || undefined;
	}
	/**
	...
	public get isEmpty(): boolean {
		return !this._title && !this._author && !this._copyright && !this._description && !this._rating;
	}

	/** @inheritDoc */
	public get objectType(): ObjectType {
		return ObjectType.ContentDescriptionObject;
	}
