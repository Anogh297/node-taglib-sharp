...
export default class StreamPropertiesObject extends BaseObject {
	 ...
	 */
	public get errorCorrectionData(): ByteVector {
	 ...
	 */
	public get errorCorrectionType(): UuidWrapper {
	...
	public get objectType(): ObjectType {
		return ObjectType.StreamPropertiesObject;
	}
	...
	public get streamNumber(): number {
		return NumberUtils.uintAnd(this._flags, 0x3f);
	}

	/**
	 * Gets the stream type GUID of the current instance.
	 */
	public get streamType(): UuidWrapper {
	 ...
	 */
	public get timeOffsetMilliseconds(): number {
		return NumberUtils.ticksToMilli(this._timeOffset);
	}
	 ...
	 */
	public get typeSpecificData(): ByteVector {
