...
export default abstract class BaseObject {
	...
	protected constructor() {
		/* empty to only allow construction via static constructors */
	}
	...
	protected renderInternal(data: ByteVector): ByteVector {
		...
		return ByteVector.concatenate(this._id.toBytes(), ReadWriteUtils.renderQWord(length), data);
	}
