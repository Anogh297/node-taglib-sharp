...
export default class FilePropertiesObject extends BaseObject {
	 ...
	 * instance.
	 */
	public get dataPacketsCount(): bigint {
	 ...
	 */
	public get maximumDataPacketSize(): number {
	 ...
	 */
	public get minimumDataPacketSize(): number {
		return this._minimumDataPacketSize;
	}

	/** @inheritDoc */
	public get objectType(): ObjectType {
		return ObjectType.FilePropertiesObject;
	}
	 ...
	 */
	public get prerollMilliseconds(): number {
		return Number(this._prerollMilliseconds);
	}

	/**
	 * Get the time needed to play the file described by the current instance in milliseconds.
	 */
	public get playDurationMilliseconds(): number {
		return NumberUtils.ticksToMilli(this._playDurationTicks);
	}
	 ...
	 */
	public get sendDurationMilliseconds(): number {
		return NumberUtils.ticksToMilli(this._sendDurationTicks);
	}
