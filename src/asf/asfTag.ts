...
export default class AsfTag extends Tag {
	 ...
	 */
	public get contentDescriptionObject(): ContentDescriptionObject {
		return this._contentDescriptionObject;
	}
	 ...
	 */
	public get metadataLibraryObject(): MetadataLibraryObject {
		return this._metadataLibraryObject;
	}
	...
	public get title(): string {
		return this._contentDescriptionObject.title;
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the content description object
	...
	public set title(value: string) {
		this._contentDescriptionObject.title = value;
	}
	...
	public get subtitle(): string {
		return this.getDescriptorString("WM/SubTitle");
	}
	/**
	 * @inheritDoc
	 * @remarks
	...
	public set subtitle(value: string) {
		this.setDescriptorString(value, "WM/SubTitle");
	}
	...
	public get titleSort(): string {
		return this.getDescriptorString("WM/TitleSortOrder");
	}
	/**
	 * @inheritDoc
	 * @remarks
	...
	public set titleSort(value: string) {
		this.setDescriptorString(value, "WM/TitleSortOrder");
	}
	...
	public get description(): string {
		return this._contentDescriptionObject.description;
	}
	/**
	 * @inheritDoc
	 * @remarks
	...
	public set description(value: string) {
		this._contentDescriptionObject.description = value;
	}
	...
	public get performers(): string[] {
		return AsfTag.splitAndClean(this._contentDescriptionObject.author);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the {@link ContentDescriptionObject.author}
	...
	public set performers(value: string[]) {
		this._contentDescriptionObject.author = value.join("; ");
	}
	...
	public get performersSort(): string[] {
		return this.getDescriptorStrings("WM/ArtistSortOrder");
	}
	/**
	 * @inheritDoc
	 * @remarks
	...
	public set performersSort(value: string[]) {
		this.setDescriptorStrings(value, "WM/ArtistSortOrder");
	}
	...
	public get albumArtists(): string[] {
		return this.getDescriptorStrings("WM/AlbumArtist", "AlbumArtist");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `WM/AlbumArtist` or `AlbumArtist` descriptors
	...
	public set albumArtists(value: string[]) {
		this.setDescriptorStrings(value, "WM/AlbumArtist", "AlbumArtist");
	}
	...
	public get albumArtistsSort(): string[] {
		return this.getDescriptorStrings("WM/AlbumArtistSortOrder");
	}
	/**
	 * @inheritDoc
	 * @remarks
	...
	public set albumArtistsSort(value: string[]) {
		this.setDescriptorStrings(value, "WM/AlbumArtistSortOrder");
	}
	...
	public get composers(): string[] {
		return this.getDescriptorStrings("WM/Composer", "Composer");
	}
	/**
	 * @inheritDoc
	 * @remarks
	...
	public set composers(value: string[]) {
		this.setDescriptorStrings(value, "WM/Composer", "Composer");
	}
	...
	public get album(): string {
		return this.getDescriptorString("WM/AlbumTitle", "Album");
	}
	/**
	 * @inheritDoc
	 * @remarks
	...
	public set album(value: string) {
		this.setDescriptorString(value, "WM/AlbumTitle", "Album");
	}
	...
	public get albumSort(): string {
		return this.getDescriptorString("WM/AlbumSortOrder");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `WM/AlbumSortOrder` descriptors
	...
	public set albumSort(value: string) {
		this.setDescriptorString(value, "WM/AlbumSortOrder");
	}
	...
	public get comment(): string {
		return this.getDescriptorString("WM/Text");
	}
	/**
	 * @inheritDoc
	 * @remarks
	...
	public set comment(value: string) {
		this.setDescriptorString(value, "WM/Text");
	}
	...
	public get track(): number {
		return this.getDescriptorUint("WM/TrackNumber");
	}
	/**
	 * @inheritDoc
	 * @remarks
	...
	public get trackCount(): number {
		return this.getDescriptorUint("TrackTotal");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TrackTotal` descriptor
	...
	public get lyrics(): string {
		return this.getDescriptorString("WM/Lyrics");
	}
	/**
	 * @inheritDoc
	 * @remarks
	...
	public set lyrics(value: string) {
		this.setDescriptorString(value, "WM/Lyrics");
	}
	...
	public get grouping(): string {
		return this.getDescriptorString("WM/ContentGroupDescription");
	}
	/**
	 * @inheritDoc
	 * @remarks
	...
	public set grouping(value: string) {
		this.setDescriptorString(value, "WM/ContentGroupDescription");
	}
	...
	public get beatsPerMinute(): number {
		return this.getDescriptorUint("WM/BeatsPerMinute");
	}
	/**
	 * @inheritDoc
	 * @remarks
	...
	public get conductor(): string {
		return this.getDescriptorString("WM/Conductor");
	}
	/**
	 * @inheritDoc
	 * @remarks
	...
	public set conductor(value: string) {
		this.setDescriptorString(value, "WM/Conductor");
	}
	...
	public get copyright(): string {
		return this._contentDescriptionObject.copyright;
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the {@link ContentDescriptionObject.copyright}
	...
	public set copyright(value: string) {
		this._contentDescriptionObject.copyright = value;
	}
	...
	public get musicBrainzArtistId(): string {
		return this.getDescriptorString("MusicBrainz/Artist Id");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MusicBrainz/Artist Id` descriptor
	...
	public get musicBrainzReleaseId(): string {
		return this.getDescriptorString("MusicBrainz/Album Id");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MusicBrainz/Album Id` descriptor
	...
	public get musicBrainzTrackId(): string {
		return this.getDescriptorString("MusicBrainz/Track Id");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MusicBrainz/Track Id` descriptor
	...
	public set musicBrainzTrackId(value: string) {
		this.setDescriptorString(value, "MusicBrainz/Track Id");
	}
	...
	public get musicBrainzDiscId(): string {
		return this.getDescriptorString("MusicBrainz/Disc Id");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MusicBrainz/Disc Id` descriptor
	...
	public set musicBrainzDiscId(value: string) {
		this.setDescriptorString(value, "MusicBrainz/Disc Id");
	}
	...
	public get musicIpId(): string {
		return this.getDescriptorString("MusicIP/PUID");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MusicIP/PUID` descriptor
	...
	public set musicIpId(value: string) {
		this.setDescriptorString(value, "MusicIP/PUID");
	}
	...
	public get musicBrainzReleaseType(): string {
		return this.getDescriptorString("MusicBrainz/Album Type");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MusicBrainz/Album Type` descriptor
	...
	public get pictures(): IPicture[] {
		const records = [...this.getDescriptors("WM/Picture"), ...this._metadataLibraryObject.getRecords(0, 0, "WM/Picture")];
		return records.map((r) => AsfTag.pictureFromData(r.byteValue)).filter((p) => !!p);
	}
	/**
	 * @inheritDoc
	 * @remarks
