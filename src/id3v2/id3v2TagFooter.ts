...
export default class Id3v2TagFooter {
	...
	public get majorVersion(): number {
		return this._majorVersion === 0 ? Id3v2Settings.defaultVersion : this._majorVersion;
	}
	/**
	 * Sets the major version of the tag described by the current instance.
	...
	public render(): ByteVector {
		return ByteVector.concatenate(Id3v2TagFooter.FILE_IDENTIFIER, this.majorVersion, this.revisionNumber, this.flags, SyncData.fromUint(this.tagSize));
	}
}
