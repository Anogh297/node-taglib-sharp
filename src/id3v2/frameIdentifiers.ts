...
export class FrameIdentifier {
	...
	public constructor(v4: string, v3: string, v2: string) {
		...
		this._version4 = v4 ? ByteVector.fromString(v4, StringType.Latin1).makeReadOnly() : undefined;
		this._version3 = v3 ? (v3 === v4 ? this._version4 : ByteVector.fromString(v3, StringType.Latin1).makeReadOnly()) : undefined;
		this._version2 = v2 ? ByteVector.fromString(v2, StringType.Latin1).makeReadOnly() : undefined;
	}
	...
	public get isTextFrame(): boolean {
		const t = 0x54; // T
		return this._version2?.get(0) === t || this._version3?.get(0) === t || this._version4?.get(0) === t;
	}
	...
	public get isUrlFrame(): boolean {
		const w = 0x57; // W
		return this._version2?.get(0) === w || this._version3?.get(0) === w || this._version4?.get(0) === w;
	}
