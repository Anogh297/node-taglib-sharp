...
export default class Id3v2Tag extends Tag {
	...
	public static set language(value: string) {
		Id3v2Tag._language = !value || value.length < 3 ? "   " : value.substring(0, 3);
	}

	/**
	 * Gets the header flags applied to the current instance.
	 */
	public get flags(): Id3v2TagHeaderFlags {
	...
	public set version(value: number) {
		...
		if (value === 4 && (originalVersion === 2 || originalVersion === 3)) {
			// * TYER, etc -> TDRC
			const tyerFrames = this.getFramesByIdentifier<TextInformationFrame>(FrameClassType.TextInformationFrame, FrameIdentifiers.TYER);
			const tdatFrames = this.getFramesByIdentifier<TextInformationFrame>(FrameClassType.TextInformationFrame, FrameIdentifiers.TDAT);
			const timeFrames = this.getFramesByIdentifier<TextInformationFrame>(FrameClassType.TextInformationFrame, FrameIdentifiers.TIME);
			...
			// * TDRC -> TYER, etc
			const tdrcFrames = this.getFramesByIdentifier<TextInformationFrame>(FrameClassType.TextInformationFrame, FrameIdentifiers.TDRC);
	...
	public get sizeOnDisk(): number {
		return this._header.completeTagSize;
	}

	/**
	 * @inheritDoc
	 * @remarks Stored in the `TIT2` frame
	 */
	public get title(): string {
		return this.getTextAsString(FrameIdentifiers.TIT2);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TIT2` frame
	...
	public set title(value: string) {
		this.setTextFrame(FrameIdentifiers.TIT2, value);
	}

	/**
	 * @inheritDoc
	 * @remarks Stored in the `TSOT` frame
	 */
	get titleSort(): string {
		return this.getTextAsString(FrameIdentifiers.TSOT);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TSOT` frame
	...
	set titleSort(value: string) {
		this.setTextFrame(FrameIdentifiers.TSOT, value);
	}

	/**
	 * @inheritDoc
	 * @remarks Stored in the `TIT3` frame
	 */
	get subtitle(): string {
		return this.getTextAsString(FrameIdentifiers.TIT3);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TIT3` frame
	...
	set subtitle(value: string) {
		this.setTextFrame(FrameIdentifiers.TIT3, value);
	}

	/**
	 * @inheritDoc
	 * @remarks via user text frame "description"
	 */
	get description(): string {
		return this.getUserTextAsString("Description");
	}
	/**
	 * @inheritDoc
	 * @remarks via user text frame "description"
	...
	set description(value: string) {
		this.setUserTextAsString("Description", value);
	}

	/**
	 * @inheritDoc
	 * @remarks Stored in the `TPE1` frame
	 */
	get performers(): string[] {
		return this.getTextAsArray(FrameIdentifiers.TPE1);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TPE1` frame
	...
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TSOP` frame
	 */
	get performersSort(): string[] {
		return this.getTextAsArray(FrameIdentifiers.TSOP);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TSOP` frame
	 */
	set performersSort(value: string[]) {
		this.setTextFrame(FrameIdentifiers.TSOP, ...value);
	}

	/**
	 * @inheritDoc
	 * @remarks Stored in the `TMCL` frame
	 */
	...
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TSO2` frame
	 */
	get albumArtists(): string[] {
		return this.getTextAsArray(FrameIdentifiers.TPE2);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TSO2` frame
	...
	set albumArtists(value: string[]) {
		this.setTextFrame(FrameIdentifiers.TPE2, ...value);
	}

	/**
	 * @inheritDoc
	 * @remarks Stored in the `TPE2` frame
	 */
	get albumArtistsSort(): string[] {
		return this.getTextAsArray(FrameIdentifiers.TSO2);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TPE2` frame
	 */
	set albumArtistsSort(value: string[]) {
		this.setTextFrame(FrameIdentifiers.TSO2, ...value);
	}

	/**
	 * @inheritDoc
	 * @remarks Stored in the `TCOM` frame
	 */
	get composers(): string[] {
		return this.getTextAsArray(FrameIdentifiers.TCOM);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TCOM` frame
	...
	set composers(value: string[]) {
		this.setTextFrame(FrameIdentifiers.TCOM, ...value);
	}

	/**
	 * @inheritDoc
	 * @remarks Stored in the `TSOC` frame
	 */
	get composersSort(): string[] {
		return this.getTextAsArray(FrameIdentifiers.TSOC);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TSOC` frame
	 */
	set composersSort(value: string[]) {
		this.setTextFrame(FrameIdentifiers.TSOC, ...value);
	}

	/**
	 * @inheritDoc
	 * @remarks Stored in the `TALB` frame
	 */
	get album(): string {
		return this.getTextAsString(FrameIdentifiers.TALB);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TALB` frame
	...
	set album(value: string) {
		this.setTextFrame(FrameIdentifiers.TALB, value);
	}

	/**
	 * @inheritDoc
	 * @remarks Stored in the `TSOA` frame
	 */
	get albumSort(): string {
		return this.getTextAsString(FrameIdentifiers.TSOA);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TSOA` frame
	...
	set albumSort(value: string) {
		this.setTextFrame(FrameIdentifiers.TSOA, value);
	}
	...
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TCON` frame
	 */
	get genres(): string[] {
	...
	/**
	 * @inheritDoc
	 * @remarks NOTE: values >9999 will remove the frame
	 */
	...
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TRCK` frame
	 */
	get track(): number {
		return this.getTextAsUint32(FrameIdentifiers.TRCK, 0);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TRCK` frame
	...
	set track(value: number) {
		this.setNumberFrame(FrameIdentifiers.TRCK, value, this.trackCount, 2);
	}
	...
	get trackCount(): number {
		return this.getTextAsUint32(FrameIdentifiers.TRCK, 1);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TRCK` frame
	...
	set trackCount(value: number) {
		this.setNumberFrame(FrameIdentifiers.TRCK, this.track, value);
	}

	/**
	 * @inheritDoc
	 * @remarks Stored in the `TPOS` frame
	 */
	get disc(): number {
		return this.getTextAsUint32(FrameIdentifiers.TPOS, 0);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TPOS` frame
	...
	set disc(value: number) {
		this.setNumberFrame(FrameIdentifiers.TPOS, value, this.discCount);
	}
	...
	get discCount(): number {
		return this.getTextAsUint32(FrameIdentifiers.TPOS, 1);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TPOS` frame
	 */
	set discCount(value: number) {
		this.setNumberFrame(FrameIdentifiers.TPOS, this.disc, value);
	}
	...
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TIT1` frame
	 */
	get grouping(): string {
		return this.getTextAsString(FrameIdentifiers.TIT1);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TIT1` frame
	...
	set grouping(value: string) {
		this.setTextFrame(FrameIdentifiers.TIT1, value);
	}

	/**
	 * @inheritDoc
	 * @remarks Stored in the `TBPM` frame
	 */
	...
	set beatsPerMinute(value: number) {
		this.setNumberFrame(FrameIdentifiers.TBPM, value, 0);
	}

	/**
	 * @inheritDoc
	 * @remarks Stored in the `TPE3` frame
	 */
	get conductor(): string {
		return this.getTextAsString(FrameIdentifiers.TPE3);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TPE3` frame
	...
	set conductor(value: string) {
		this.setTextFrame(FrameIdentifiers.TPE3, value);
	}

	/**
	 * @inheritDoc
	 * @remarks Stored in the `TCOP` frame
	 */
	get copyright(): string {
		return this.getTextAsString(FrameIdentifiers.TCOP);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TCOP` frame
	...
	set copyright(value: string) {
		this.setTextFrame(FrameIdentifiers.TCOP, value);
	}
	...
	/**
	 * @inheritDoc
	 * @remarks via TXXX:MusicBrainz Artist Id frame
	 */
	 ...
	 * @remarks via TXXX:MusicBrainz Artist Id frame
	 */
	set musicBrainzArtistId(value: string) {
	...
	get musicBrainzReleaseGroupId(): string {
		return this.getUserTextAsString("MusicBrainz Release Group Id");
	}
	/**
	 * @inheritDoc
	 * @remarks via TXXX:MusicBrainz Release Group Id frame
	 */
	set musicBrainzReleaseGroupId(value: string) {
		this.setUserTextAsString("MusicBrainz Release Group Id", value);
	}
	 ...
	 * @remarks via TXXX:MusicBrainz Album Id frame
	 */
	set musicBrainzReleaseId(value: string) {
	 ...
	 * @remarks via TXXX:MusicBrainz Album Artist Id frame
	 */
	set musicBrainzReleaseArtistId(value: string) {
	 ...
	 * @remarks via UFID:http://musicbrainz.org frame
	 */
	set musicBrainzTrackId(value: string) {
	 ...
	 * @remarks via TXXX:MusicBrainz Disc Id frame
	 */
	set musicBrainzDiscId(value: string) {
	 ...
	 * @remarks via TXXX:MusicBrainz Album Status frame
	 */
	set musicBrainzReleaseStatus(value: string) {
	 ...
	 * @remarks via TXXX:MusicBrainz Album Type frame
	 */
	set musicBrainzReleaseType(value: string) {
	...
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TKEY` frame
	 */
	get initialKey(): string {
		return this.getTextAsString(FrameIdentifiers.TKEY);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TKEY` frame
	...
	set initialKey(value: string) {
		this.setTextFrame(FrameIdentifiers.TKEY, value);
	}

	/**
	 * @inheritDoc
	 * @remarks Stored in the `TPE4` frame
	 */
	get remixedBy(): string {
		return this.getTextAsString(FrameIdentifiers.TPE4);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TPE4` frame
	 */
	set remixedBy(value: string) {
		this.setTextFrame(FrameIdentifiers.TPE4, value);
	}

	/**
	 * @inheritDoc
	 * @remarks Stored in the `TPUB` frame
	 */
	get publisher(): string {
		return this.getTextAsString(FrameIdentifiers.TPUB);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TPUB` frame
	...
	set publisher(value: string) {
		this.setTextFrame(FrameIdentifiers.TPUB, value);
	}

	/**
	 * @inheritDoc
	 * @remarks Stored in the `TSRC` frame
	 */
	get isrc(): string {
		return this.getTextAsString(FrameIdentifiers.TSRC);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TSRC` frame
	...
	set isrc(value: string) {
		this.setTextFrame(FrameIdentifiers.TSRC, value);
	}
	...
	public render(): ByteVector {
		...
		const unsyncAtFrameLevel = (this._header.flags & Id3v2TagHeaderFlags.Unsynchronization) !== 0 && this.version >= 4;
		const unsyncAtTagLevel = (this._header.flags & Id3v2TagHeaderFlags.Unsynchronization) !== 0 && this.version < 4;
		...
		let paddingBytes;
		if (!hasFooter) {
			const size = frameBytes.length < this._header.tagSize ? this._header.tagSize - frameBytes.length : 1024;
		...
		return ByteVector.concatenate(headerBytes, frameBytes, paddingBytes, footerBytes);
	}
	...
	private parse(data: ByteVector, file: File, position: number, style: ReadStyle): void {
		...
		// resynchronize it.
		const fullTagUnsync = this._header.majorVersion < 4 && (this._header.flags & Id3v2TagHeaderFlags.Unsynchronization) !== 0;

		// Avoid loading all the ID3 tag if PictureLazy is enabled and size is significant enough
		// (ID3v2.4 and later only)
		if (
			file &&
			(fullTagUnsync || this._header.tagSize < 1024 || (style & ReadStyle.PictureLazy) !== 0 || (this._header.flags & Id3v2TagHeaderFlags.ExtendedHeader) !== 0)
		) {
			file.seek(position);
		...
		while (frameDataPosition < frameDataEndPosition) {
			const frameRead = FrameFactory.createFrame(data, file, frameDataPosition, this._header.majorVersion, fullTagUnsync);
