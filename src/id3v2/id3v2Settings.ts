...
export default class Id3v2Settings {
	 ...
	 */
	public static get defaultEncoding(): StringType {
	 ...
	 */
	public static set defaultEncoding(value: StringType) {
	 ...
	 */
	public static get defaultVersion(): number {
		return Id3v2Settings._defaultVersion;
	}
	/**
	 ...
	 */
	public static get footerSize(): number {
		return 10;
	}
	 ...
	 * original encoding.
	 */
	public static get forceDefaultEncoding(): boolean {
		return Id3v2Settings._forceDefaultEncoding;
	}
	/**
	 ...
	 */
	public static set forceDefaultEncoding(value: boolean) {
		Id3v2Settings._forceDefaultEncoding = value;
	}
	 ...
	 * version.
	 */
	public static get forceDefaultVersion(): boolean {
		return this._forceDefaultVersion;
	}
	/**
	 ...
	 */
	public static set forceDefaultVersion(value: boolean) {
		this._forceDefaultVersion = value;
	}
	 ...
	 * stored as "17".
	 */
	public static get useNumericGenres(): boolean {
		return this._useNumericGenres;
	}
	/**
	 ...
	 */
	public static set useNumericGenres(value: boolean) {
		this._useNumericGenres = value;
	}
	 ...
	 */
	public static get strictFrameForVersion(): boolean {
		return this._strictFramesForVersion;
	}
	/**
	 ...
	 * will be omitted from rendering and no error will be thrown.
	 */
	public static set strictFrameForVersion(value: boolean) {
		this._strictFramesForVersion = value;
	}
