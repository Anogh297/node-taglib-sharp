...
export class Id3v2TagHeader {
	...
	public get majorVersion(): number {
		return this._majorVersion === 0 || Id3v2Settings.forceDefaultVersion ? Id3v2Settings.defaultVersion : this._majorVersion;
	}
	/**
	...
	public render(): ByteVector {
		return ByteVector.concatenate(Id3v2TagHeader.FILE_IDENTIFIER, this.majorVersion, this.revisionNumber, this.flags, SyncData.fromUint(this.tagSize));
	}
}
