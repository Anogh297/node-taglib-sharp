...
export default class UniqueFileIdentifierFrame extends Frame {
	 ...
	 */
	public static fromOffsetRawData(data: ByteVector, offset: number, header: Id3v2FrameHeader, version: number): UniqueFileIdentifierFrame {
	...
	public get frameClassType(): FrameClassType {
		return FrameClassType.UniqueFileIdentifierFrame;
	}
	 ...
	 */
	public get identifier(): ByteVector {
	...
	protected renderFields(): ByteVector {
		return ByteVector.concatenate(ByteVector.fromString(this._owner, StringType.Latin1), ByteVector.getTextDelimiter(StringType.Latin1), this._identifier);
	}
