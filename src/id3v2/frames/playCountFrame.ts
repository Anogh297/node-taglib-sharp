...
export default class PlayCountFrame extends Frame {
	 ...
	 */
	public static fromOffsetRawData(data: ByteVector, offset: number, header: Id3v2FrameHeader, version: number): PlayCountFrame {
	...
	public get frameClassType(): FrameClassType {
		return FrameClassType.PlayCountFrame;
	}
