...
export default class UnsynchronizedLyricsFrame extends Frame {
	 ...
	 */
	public static fromData(description: string, language?: string, encoding: StringType = Id3v2Settings.defaultEncoding): UnsynchronizedLyricsFrame {
	 ...
	 */
	public static fromOffsetRawData(data: ByteVector, offset: number, header: Id3v2FrameHeader, version: number): UnsynchronizedLyricsFrame {
	...
	public get frameClassType(): FrameClassType {
		return FrameClassType.UnsynchronizedLyricsFrame;
	}
	...
	public get language(): string {
		return this._language && this._language.length === 3 ? this._language : "XXX";
	}
	/**
	 ...
	 */
	public static find(frames: UnsynchronizedLyricsFrame[], description: string, language: string): UnsynchronizedLyricsFrame {
	 ...
	 */
	public static findAll(frames: UnsynchronizedLyricsFrame[], description: string, language: string): UnsynchronizedLyricsFrame[] {
		Guards.truthy(frames, "frames");
	 ...
	 */
	public static findPreferred(frames: UnsynchronizedLyricsFrame[], description: string, language: string): UnsynchronizedLyricsFrame {
		Guards.truthy(frames, "frames");
