...
export class SynchronizedText {
	...
	public render(encoding: StringType): ByteVector {
		return ByteVector.concatenate(ByteVector.fromString(this.text, encoding), ByteVector.getTextDelimiter(encoding), ByteVector.fromUint(this.time));
	}
}
...
export class SynchronizedLyricsFrame extends Frame {
	 ...
	 */
	public static fromOffsetRawData(data: ByteVector, offset: number, header: Id3v2FrameHeader, version: number): SynchronizedLyricsFrame {
	...
	public get frameClassType(): FrameClassType {
		return FrameClassType.SynchronizedLyricsFrame;
	}
	 ...
	 */
	public get format(): TimestampFormat {
		return this._format;
	}
	/**
	 ...
	 */
	public set format(value: TimestampFormat) {
		this._format = value;
	}
	 ...
	 */
	public get text(): SynchronizedText[] {
		return this._text;
	}
	/**
	 ...
	 */
	public set text(value: SynchronizedText[]) {
		this._text = value || [];
	}
	 ...
	 */
	public get textType(): SynchronizedTextType {
	...
	public set textType(value: SynchronizedTextType) {
	 ...
	 */
	public static find(frames: SynchronizedLyricsFrame[], description: string, textType: SynchronizedTextType, language?: string): SynchronizedLyricsFrame {
	 ...
	 */
	public static findPreferred(frames: SynchronizedLyricsFrame[], description: string, language: string, textType: SynchronizedTextType): SynchronizedLyricsFrame {
		Guards.truthy(frames, "frames");
	...
	/** @inheritDoc */
	public clone(): Frame {
		const frame = SynchronizedLyricsFrame.fromInfo(this.description, this._language, this.textType, this.textEncoding);
