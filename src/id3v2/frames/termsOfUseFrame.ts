...
export default class TermsOfUseFrame extends Frame {
	 ...
	 */
	public static fromFields(language: string, textEncoding: StringType = Id3v2Settings.defaultEncoding): TermsOfUseFrame {
	 ...
	 */
	public static fromOffsetRawData(data: ByteVector, offset: number, header: Id3v2FrameHeader, version: number): TermsOfUseFrame {
	...
	public get frameClassType(): FrameClassType {
		return FrameClassType.TermsOfUseFrame;
	}
	...
	public get language(): string {
		return this._language && this._language.length > 2 ? this._language.substring(0, 3) : "XXX";
	}
	/**
	...
	protected renderFields(version: number): ByteVector {
		...
		return ByteVector.concatenate(encoding, ByteVector.fromString(this.language, StringType.Latin1), ByteVector.fromString(this.text, encoding));
	}
