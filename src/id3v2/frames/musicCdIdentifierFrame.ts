...
export default class MusicCdIdentifierFrame extends Frame {
	 ...
	 */
	public static fromOffsetRawData(data: ByteVector, offset: number, header: Id3v2FrameHeader, version: number): MusicCdIdentifierFrame {
	...
	public get frameClassType(): FrameClassType {
		return FrameClassType.MusicCdIdentifierFrame;
	}
