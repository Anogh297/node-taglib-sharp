...
export class ChannelData {
	 ...
	 */
	public get peakBits(): number {
		return this._peakBits;
	}
	/**
	 * Number of bits used to express the peak volume.
	 ...
	 */
	public get volumeAdjustment(): number {
		return this._volumeAdjustment / 512;
	}
	/**
...
export class RelativeVolumeFrame extends Frame {
	 ...
	 */
	public static fromOffsetRawData(data: ByteVector, offset: number, header: Id3v2FrameHeader, version: number): RelativeVolumeFrame {
	...
	public get frameClassType(): FrameClassType {
		return FrameClassType.RelativeVolumeFrame;
	}
	...
	public get channels(): ChannelData[] {
		return this._channels.filter((c) => c.isSet);
	}
	 ...
	 * @param type Which channel to get the value for
	 */
	public getPeakVolume(type: ChannelType): bigint {
	 ...
	 */
	public setPeakBits(type: ChannelType, value: number): void {
	 ...
	 * @param value Peak volume
	 */
	public setPeakVolume(type: ChannelType, value: bigint): void {
