...
export abstract class Frame {
	...
	public get encryptionId(): number | undefined {
		return NumberUtils.hasFlag(this.flags, Id3v2FrameFlags.Encryption) ? this._encryptionId : undefined;
	}
	/**
	 ...
	 */
	public get flags(): Id3v2FrameFlags {
	 ...
	 * @protected
	 */
	protected set header(value: Id3v2FrameHeader) {
		this._header = value;
	}
	 ...
	 */
	public get frameId(): FrameIdentifier {
	...
	public get groupId(): number | undefined {
		return NumberUtils.hasFlag(this.flags, Id3v2FrameFlags.GroupingIdentity) ? this._groupId : undefined;
	}
	/**
	...
	public render(version: number): ByteVector {
		...
		const frontDataSize = frontData.reduce<number>((accum, e) => {
			accum += e instanceof ByteVector ? e.length : 1;
			return accum;
		}, 0);
		this._header.frameSize = fieldData.length + frontDataSize;

		return ByteVector.concatenate(this._header.render(version), ...frontData, fieldData);
	}
	 ...
	 *     otherwise
	 */
	protected fieldData(frameData: ByteVector, offset: number, version: number, dataIncludesHeader: boolean): ByteVector {
