...
export default class CommentsFrame extends Frame {
	 ...
	 */
	public static fromDescription(description: string, language?: string, encoding: StringType = Id3v2Settings.defaultEncoding): CommentsFrame {
	...
	public get frameClassType(): FrameClassType {
		return FrameClassType.CommentsFrame;
	}
