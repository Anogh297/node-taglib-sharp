...
export default class PrivateFrame extends Frame {
	 ...
	 */
	public static fromOffsetRawData(data: ByteVector, offset: number, header: Id3v2FrameHeader, version: number): PrivateFrame {
	...
	public get frameClassType(): FrameClassType {
		return FrameClassType.PrivateFrame;
	}
	 ...
	 */
	public get privateData(): ByteVector {
	 ...
	 */
	public set privateData(value: ByteVector) {
	...
	protected renderFields(version: number): ByteVector {
		...
		return ByteVector.concatenate(ByteVector.fromString(this._owner, StringType.Latin1), ByteVector.getTextDelimiter(StringType.Latin1), this._privateData);
	}
}
