...
export default abstract class SandwichFile extends File implements ISandwichFile {
	 ...
	 * @protected
	 */
	protected constructor(fileToRead: IFileAbstraction | string, readStyle: ReadStyle, defaultTagMappingTable: Map<TagTypes, () => boolean>, defaultTags: TagTypes) {
		super(fileToRead);
