...
export default abstract class TagParser {
	...
	protected set currentTag(value: Tag) {
	...
	protected get fileOffset(): number {
		return this._fileOffset;
	}
	protected set fileOffset(value: number) {
		this._fileOffset = value;
	}

	protected get readStyle(): ReadStyle {
		return this._readStyle;
	}
