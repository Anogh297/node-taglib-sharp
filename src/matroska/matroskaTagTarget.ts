...
export class MatroskaTagTarget {
	...
	private constructor() {
		/* No implementation to enforce private constructor */
	}
	 ...
	 */
	public get attachmentUids(): bigint[] {
		return this._attachmentUids;
	}

	/**
	 * Gets a collection of chapter UIDs that tags with this target apply to.
	 */
	public get chapterUids(): bigint[] {
		return this._chapterUids;
	}

	/**
	 * Gets a collection of edition UIDs that tags with this target apply to.
	 */
	public get editionUids(): bigint[] {
		return this._editionUids;
	}
	 ...
	 */
	public get targetType(): MatroskaTagTargetType {
	 ...
	 */
	public get trackUids(): bigint[] {
		return this._trackUids;
	}
}
