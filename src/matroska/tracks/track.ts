...
export class Track implements ICodec {
	 ...
	 */
	public get codecPrivateData(): ByteVector {
		return this._codecPrivateData;
	}
	 ...
	 */
	public get isHearingImpaired(): boolean {
		return this._isHearingImpaired;
	}

	/**
	 * Is `true` if the track is suitable for users with visual impairments.
	 */
	public get isVisualImpaired(): boolean {
		return this._isVisualImpaired;
	}
	...
	public get language(): string {
		return this._languageIetf || this._language;
	}
	 ...
	 * Type of the track.
	 */
	public get type(): MatroskaTrackType {
		return this._type;
	}
