...
export default class MatroskaTagValue {
	...
	public static fromSimpleTagElement(element: EbmlElement, matroskaVersion: number): MatroskaTagValue {
		...
		const simpleTagParseActions = new Map<number, (e: EbmlElement) => void>([
			...
			[MatroskaIds.SIMPLE_TAG, (e) => simpleTag._nestedTags.push(MatroskaTagValue.fromSimpleTagElement(e, matroskaVersion))],
		]);
	...
	public get isBinary(): boolean {
		return this._value instanceof ByteVector;
	}
	 ...
	 */
	public set isDefaultLanguage(value: boolean) {
		this._isDefaultLanguage = value;
	}
	 ...
	 */
	public get nestedTags(): MatroskaTagValue[] {
		return this._nestedTags;
	}
	/**
	 ...
	 */
	public get value(): string | ByteVector {
		return this._value;
	}
	/**
