...
export default class FlacFileSettings {
	 ...
	 */
	public static readonly SUPPORTED_TAG_TYPES: TagTypes = TagTypes.Id3v1 | TagTypes.Id3v2 | TagTypes.Ape | TagTypes.Xiph;
	...
	public static set defaultTagTypes(value: TagTypes) {
		...
		if (unsupportedTagTypes !== 0) {
			throw new Error(`Argument error: node-taglib-sharp does not support tag types ${unsupportedTagTypes} for FLAC files`);
		}
	 ...
	 * @default `true`
	 */
	public static get preferApeTagAtFileEnd(): boolean {
		return this._preferApeTagAtFileEnd;
	}
	/**
	 * Gets whether or not *new* APE tags should be stored at the end of the file. If `true` new
	 * APE tags will be stored at the end of the file. If `false` new APE tags will be stored at
	 ...
	 * @default `true`
	 */
	public static set preferApeTagAtFileEnd(value: boolean) {
		this._preferApeTagAtFileEnd = value;
	}
	 ...
	 * @default `false`
	 */
	public static get preferId3v2TagAtFileEnd(): boolean {
		return this._preferId3v2TagAtFileEnd;
	}
	/**
	 ...
	 * @default `false`
	 */
	public static set preferId3v2TagAtFileEnd(value: boolean) {
		this._preferId3v2TagAtFileEnd = value;
	}
}
