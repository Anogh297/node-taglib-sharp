...
export default class FlacTag extends CombinedTag {
	...
	public get xiphComment(): XiphComment {
	...
	public get pictures(): IPicture[] {
		...
		return this._pictures && this._pictures.length > 0 ? this._pictures.slice() : super.pictures;
	}
	/**
	 * @inheritDoc
	...
	public get tagTypes(): TagTypes {
		return this._pictures && this._pictures.length > 0 ? super.tagTypes | TagTypes.FlacPictures : super.tagTypes;
	}
