...
export class ApeTagFooter {
	...
	private constructor() {
		/* empty to enforce static construction */
	}
	 ...
	 */
	public get flags(): ApeTagFooterFlags {
		return this._flags;
	}
	/**
	 * Sets the flags that apply to the current instance.
	 */
	public set flags(value: ApeTagFooterFlags) {
		this._flags = value;
	}
	 ...
	 */
	public get requiredDataSize(): number {
		return this.itemSize + ApeTagFooter.SIZE;
	}
	...
	public get tagSize(): number {
		...
		return this._itemSize + ApeTagFooter.SIZE + (NumberUtils.hasFlag(this._flags, ApeTagFooterFlags.HeaderPresent) ? ApeTagFooter.SIZE : 0);
	}
	...
	public get version(): number {
		return this._version === 0 ? 2000 : this._version;
	}
	...
	public renderHeader(): ByteVector {
		return NumberUtils.hasFlag(this.flags, ApeTagFooterFlags.HeaderPresent) ? this.render(true) : ByteVector.empty();
	}
