...
export default class ApeTag extends Tag {
	...
	public set title(value: string) {
		this.setStringValue("Title", value);
	}
	...
	get titleSort(): string {
		return this.getStringValue("TitleSort");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TitleSort` item
	...
	set titleSort(value: string) {
		this.setStringValue("TitleSort", value);
	}
	 ...
	 */
	get subtitle(): string {
		return this.getStringValue("Subtitle");
	}
	/**
	 * @inheritDoc
	...
	set subtitle(value: string) {
		this.setStringValue("Subtitle", value);
	}
	...
	get performers(): string[] {
		return this.getStringValues("Artist");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `Artist` item
	...
	set performers(value: string[]) {
		this.setStringValues("Artist", value);
	}
	...
	get performersSort(): string[] {
		return this.getStringValues("ArtistSort");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `ArtistSort` item
	...
	set performersSort(value: string[]) {
		this.setStringValues("ArtistSort", value);
	}
	...
	get performersRole(): string[] {
		return this.getStringValues("PerformersRole");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `PerformersRole` item
	...
	set performersRole(value: string[]) {
		this.setStringValues("PerformersRole", value);
	}
	...
	get albumArtistsSort(): string[] {
		return this.getStringValues("AlbumArtistSort");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `AlbumArtistSort` item
	...
	set albumArtistsSort(value: string[]) {
		this.setStringValues("AlbumArtistSort", value);
	}
	...
	get composers(): string[] {
		return this.getStringValues("Composer");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `Composer` item
	...
	set composers(value: string[]) {
		this.setStringValues("Composer", value);
	}
	...
	get composersSort(): string[] {
		return this.getStringValues("ComposerSort");
	}
	/**
	 * @inheritDoc
	...
	set composersSort(value: string[]) {
		this.setStringValues("ComposerSort", value);
	}
	 ...
	 */
	get album(): string {
		return this.getStringValue("Album");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `Album` item
	...
	set album(value: string) {
		this.setStringValue("Album", value);
	}
	...
	get albumSort(): string {
		return this.getStringValue("AlbumSort");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `AlbumSort` item
	...
	set albumSort(value: string) {
		this.setStringValue("AlbumSort", value);
	}
	...
	set comment(value: string) {
		this.setStringValue("Comment", value);
	}
	 ...
	 */
	get genres(): string[] {
		return this.getStringValues("Genre");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `Genre` item
	...
	set genres(value: string[]) {
		this.setStringValues("Genre", value);
	}
	...
	set year(value: number) {
		this.setNumericValue("Year", value, 0);
	}
	 ...
	 */
	get track(): number {
		return this.getUint32Value("Track", 0);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `Track` item numerator
	...
	set track(value: number) {
		this.setNumericValue("Track", value, this.trackCount);
	}
	...
	get trackCount(): number {
		return this.getUint32Value("Track", 1);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `Track` item denominator
	...
	set trackCount(value: number) {
		this.setNumericValue("Track", this.track, value);
	}
	 ...
	 */
	get disc(): number {
		return this.getUint32Value("Disc", 0);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `Disc` item numerator
	...
	set disc(value: number) {
		this.setNumericValue("Disc", value, this.discCount);
	}
	...
	get discCount(): number {
		return this.getUint32Value("Disc", 1);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `Disc` item denominator
	...
	set discCount(value: number) {
		this.setNumericValue("Disc", this.disc, value);
	}
	 ...
	 */
	get lyrics(): string {
		return this.getStringValue("Lyrics");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `Lyrics` item
	...
	set lyrics(value: string) {
		this.setStringValue("Lyrics", value);
	}
	 ...
	 */
	get grouping(): string {
		return this.getStringValue("Grouping");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `Grouping` item
	...
	set grouping(value: string) {
		this.setStringValue("Grouping", value);
	}
	...
	get beatsPerMinute(): number {
		return this.getUint32Value("BPM", 0);
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `BPM` item
	...
	set beatsPerMinute(value: number) {
		this.setNumericValue("BPM", value, 0);
	}
	...
	get conductor(): string {
		return this.getStringValue("Conductor");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `Conductor` item
	...
	set conductor(value: string) {
		this.setStringValue("Conductor", value);
	}
	...
	get copyright(): string {
		return this.getStringValue("Copyright");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `Copyright` item
	...
	set copyright(value: string) {
		this.setStringValue("Copyright", value);
	}
	...
	get musicBrainzArtistId(): string {
		return this.getStringValue("MUSICBRAINZ_ARTISTID");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MUSICBRAINZ_ARTISTID` item
	...
	set musicBrainzArtistId(value: string) {
		this.setStringValue("MUSICBRAINZ_ARTISTID", value);
	}
	...
	get musicBrainzReleaseGroupId(): string {
		return this.getStringValue("MUSICBRAINZ_RELEASEGROUPID");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MUSICBRAINZ_RELEASEGROUPID` item
	...
	set musicBrainzReleaseGroupId(value: string) {
		this.setStringValue("MUSICBRAINZ_RELEASEGROUPID", value);
	}
	...
	get musicBrainzReleaseId(): string {
		return this.getStringValue("MUSICBRAINZ_ALBUMID");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MUSICBRAINZ_ALBUMID` item
	...
	set musicBrainzReleaseId(value: string) {
		this.setStringValue("MUSICBRAINZ_ALBUMID", value);
	}
	...
	get musicBrainzReleaseArtistId(): string {
		return this.getStringValue("MUSICBRAINZ_ALBUMARTISTID");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MUSICBRAINZ_ALBUMARTISTID` item
	...
	set musicBrainzReleaseArtistId(value: string) {
		this.setStringValue("MUSICBRAINZ_ALBUMARTISTID", value);
	}
	...
	get musicBrainzTrackId(): string {
		return this.getStringValue("MUSICBRAINZ_TRACKID");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MUSICBRAINZ_TRACKID` item
	...
	set musicBrainzTrackId(value: string) {
		this.setStringValue("MUSICBRAINZ_TRACKID", value);
	}
	...
	get musicBrainzDiscId(): string {
		return this.getStringValue("MUSICBRAINZ_DISCID");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MUSICBRAINZ_DISCID` item
	...
	set musicBrainzDiscId(value: string) {
		this.setStringValue("MUSICBRAINZ_DISCID", value);
	}
	...
	get musicIpId(): string {
		return this.getStringValue("MUSICIP_PUID");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MUSICIP_PUID` item
	...
	set musicIpId(value: string) {
		this.setStringValue("MUSICIP_PUID", value);
	}
	 ...
	 */
	get amazonId(): string {
		return this.getStringValue("ASIN");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `ASIN` item
	...
	set amazonId(value: string) {
		this.setStringValue("ASIN", value);
	}
	...
	get musicBrainzReleaseStatus(): string {
		return this.getStringValue("MUSICBRAINZ_ALBUMSTATUS");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MUSICBRAINZ_ALBUMSTATUS` item
	...
	set musicBrainzReleaseStatus(value: string) {
		this.setStringValue("MUSICBRAINZ_ALBUMSTATUS", value);
	}
	...
	get musicBrainzReleaseType(): string {
		return this.getStringValue("MUSICBRAINZ_ALBUMTYPE");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MUSICBRAINZ_ALBUMTYPE` item
	...
	set musicBrainzReleaseType(value: string) {
		this.setStringValue("MUSICBRAINZ_ALBUMTYPE", value);
	}
	...
	get musicBrainzReleaseCountry(): string {
		return this.getStringValue("RELEASECOUNTRY");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `RELEASECOUNTRY` item
	...
	set musicBrainzReleaseCountry(value: string) {
		this.setStringValue("RELEASECOUNTRY", value);
	}
	...
	set pictures(value: IPicture[]) {
		...
		for (const pic of value) {
			...
			const data = ByteVector.concatenate(ByteVector.fromString(pic.description, StringType.UTF8), ByteVector.getTextDelimiter(StringType.UTF8), pic.data);
	...
	public copyTo(target: Tag, overwrite: boolean): void {
		...
		this._items.filter((i) => overwrite || !apeTag.getItem(i.key)).forEach((i) => apeTag.setItem(i.clone()));
	}
	...
	public render(): ByteVector {
		...
		return ByteVector.concatenate(this._footer.renderHeader(), ...renderedItems, this._footer.renderFooter());
	}
	...
	private getUint32Value(key: string, index: number): number {
		...
		return Number.isNaN(uint) || uint < 0 ? 0 : uint;
	}
