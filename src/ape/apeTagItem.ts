...
export class ApeTagItem {
	...
	public get text(): string[] {
		return this._type === ApeTagItemType.Binary || !this._text ? [] : this._text;
	}

	/**
	 * Gets the type of value contained in the current instance.
	 */
	public get type(): ApeTagItemType {
		return this._type;
	}
	 ...
	 */
	public get value(): ByteVector {
		return this._type === ApeTagItemType.Binary ? this._data : undefined;
	}
	...
	public toString(): string {
		return this._type === ApeTagItemType.Binary || !this._text ? undefined : this._text.join(", ");
	}
