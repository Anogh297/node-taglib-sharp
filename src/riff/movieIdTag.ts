...
export default class MovieIdTag extends RiffListTag {
	...
	public get title(): string {
		return this.getFirstValueAsString("TITL");
	}
	/**
	 * @inheritDoc
	 * @remarks Implemented via the `TITL` item.
	...
	public set title(value: string) {
		this.setValuesFromStrings("TITL", value ? [value] : undefined);
	}
	...
	public get comment(): string {
		return this.getFirstValueAsString("COMM");
	}
	/**
	 * @inheritDoc
	 * @remarks Implemented via the `COMM` item.
	...
	public set comment(value: string) {
		this.setValuesFromStrings("COMM", value ? [value] : undefined);
	}
	...
	public get genres(): string[] {
		return this.getValuesAsStrings("GENR");
	}
	/**
	 * @inheritDoc
	 * @remarks Implemented via the `GENR` item.
	...
	public get track(): number {
		return this.getValueAsUint("PRT1");
	}
	/**
	 * @inheritDoc
	 * @remarks Implemented via the `PRT1` item.
	...
	public set track(value: number) {
		this.setValueFromUint("PRT1", value);
	}
	...
	public get trackCount(): number {
		return this.getValueAsUint("PRT2");
	}
	/**
	 * @inheritDoc
	 * @remarks Implemented via the `PRT2` item.
	...
	public set trackCount(value: number) {
		this.setValueFromUint("PRT2", value);
	}
