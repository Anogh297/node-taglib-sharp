...
export default class AviHeader {
	 ...
	 */
	public get initialFrames(): number {
		return this._initialFrames;
	}

	/**
	 * Gets the maximum number of bytes per second.
	 */
	public get maxBytesPerSecond(): number {
	 ...
	 */
	public get microsecondsPerFrame(): number {
		return this._microsecondsPerFrame;
	}

	/**
	 * Gets the suggested buffer size for the file, in bytes.
	 */
	public get suggestedBufferSize(): number {
		return this._suggestedBufferSize;
	}
	 ...
	 */
	public get streams(): AviStream[] {
		return this._streams.slice(0);
	}
}
