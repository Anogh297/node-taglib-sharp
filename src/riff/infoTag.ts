...
export default class InfoTag extends RiffListTag {
	...
	public get title(): string {
		return this.getFirstValueAsString("INAM");
	}
	/**
	 * @inheritDoc
	 * @remarks Implemented via the `INAM` item.
	...
	public set title(value: string) {
		this.setValuesFromStrings("INAM", value ? [value] : undefined);
	}
	...
	public get description(): string {
		return this.getFirstValueAsString("ISBJ");
	}
	/**
	 * @inheritDoc
	 * @remarks Implemented via the `ISBJ` item.
	...
	public set description(value: string) {
		this.setValuesFromStrings("ISBJ", value ? [value] : undefined);
	}
	...
	public get performers(): string[] {
		return this.getValuesAsStrings("ISTR");
	}
	/**
	 * @inheritDoc
	 * @remarks Implemented via the `ISTR` item.
	...
	public get albumArtists(): string[] {
		return this.getValuesAsStrings("IART");
	}
	/**
	 * @inheritDoc
	 * @remarks Implemented via the `IART` item.
	...
	public get composers(): string[] {
		return this.getValuesAsStrings("IWRI");
	}
	/**
	 * @inheritDoc
	 * @remarks Implemented via the `IWRI` item.
	...
	public get album(): string {
		return this.getFirstValueAsString("DIRC");
	}
	/**
	 * @inheritDoc
	 * @remarks Implemented via the `DIRC` item.
	...
	public set album(value: string) {
		this.setValuesFromStrings("DIRC", value ? [value] : undefined);
	}
	...
	public get conductor(): string {
		return this.getFirstValueAsString("ICNM");
	}
	/**
	 * @inheritDoc
	 * @remarks Implemented via the `ISBJ` item.
	...
	public set conductor(value: string) {
		this.setValuesFromStrings("ICNM", value ? [value] : undefined);
	}
	...
	public get comment(): string {
		return this.getFirstValueAsString("ICMT");
	}
	/**
	 * @inheritDoc
	 * @remarks Implemented via the `ICMT` item.
	...
	public set comment(value: string) {
		this.setValuesFromStrings("ICMT", value ? [value] : undefined);
	}
	...
	public get genres(): string[] {
		return this.getValuesAsStrings("IGNR");
	}
	/**
	 * @inheritDoc
	 * @remarks Implemented via the `IGNR` item.
	...
	public get year(): number {
		return this.getValueAsUint("ICRD");
	}
	/**
	 * @inheritDoc
	 * @remarks Implemented via the `ICRD` item.
	...
	public get track(): number {
		return this.getValueAsUint("IPRT");
	}
	/**
	 * @inheritDoc
	 * @remarks Implemented via the `IPRT` item.
	...
	public set track(value: number) {
		this.setValueFromUint("IPRT", value);
	}
	...
	public get trackCount(): number {
		return this.getValueAsUint("IFRM");
	}
	/**
	 * @inheritDoc
	 * @remarks Implemented via the `IFRM` item.
	...
	public set trackCount(value: number) {
		this.setValueFromUint("IFRM", value);
	}
	...
	public get copyright(): string {
		return this.getFirstValueAsString("ICOP");
	}
	/**
	 * @inheritDoc
	 * @remarks Implemented via the `ICOP` item.
	...
	public set copyright(value: string) {
		this.setValuesFromStrings("ICOP", value ? [value] : undefined);
	}
