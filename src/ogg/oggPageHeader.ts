...
export class OggPageHeader {
	...
	public static readonly NO_PACKETS_END_IN_PAGE = ByteVector.fromByteArray([0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff]);
	 ...
	 */
	public get absoluteGranularPosition(): ByteVector {
		return this._absoluteGranularPosition;
	}
	 ...
	 */
	public get lastPacketComplete(): boolean {
		return this._lastPacketComplete;
	}

	/**
	 * Gets the sizes for the packets in the page described by the current instance.
	 */
	public get packetSizes(): number[] {
	 ...
	 */
	public get pageSequenceNumber(): number {
	 ...
	 */
	public get streamSerialNumber(): number {
	...
	public render(): ByteVector {
		const lacingValues = this._packetSizes.reduce(
			(accum, ps, i) => {
