...
export default class OggFileSettings {
	 ...
	 */
	public static get writeToAllComments(): boolean {
		return this._writeToAllComments;
	}
	/**
	 ...
	 *     streams, this means there are multiple Xiph comments per file.
	 */
	public static set writeToAllComments(value: boolean) {
		this._writeToAllComments = value;
	}
}
