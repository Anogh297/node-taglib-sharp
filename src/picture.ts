...
export class Picture implements IPicture {
	...
	private static readonly EXTENSION_TO_MIMETYPES: string[] = [
		"bin",
		"application/octet-stream", // Any kind of binary data - placed at top to act as default
		"aac",
		...
		"bmp",
		"image/x-windows-bmp", // BMP image data
		"bm",
		"image/bmp", // BMP image data
		"bz",
		...
		"htm",
		"text/html", // HyperText Markup Language (HTML)text / html
		"html",
		"text/html", // HyperText Markup Language (HTML)text / html
		"ico",
		...
		"audio/midi", // Musical Instrument Digital Interface (MIDI)
		"mp3",
		"audio/mpeg", // MPEG audio, mp3 is first since it's most likely
		"mp1",
		"audio/mpeg",
		"mp2",
		"audio/mpeg",
		...
		"image/tiff", // Tagged Image File Format(TIFF)
		"ts",
		"video/vnd.dlna.mpeg-tts", // Typescript file @TODO: Uh not in this context...
		"ttf",
		...
		"xlsx",
		"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", // excel 2007 application
		"xml",
		"application/xml", // XML
		"xul",
...
export class PictureLazy implements IPicture, ILazy {
	...
	public get type(): PictureType {
		if (this._type === PictureType.Other && !this._mimeType) {
			this.load();
		}
		return this._type;
	}
