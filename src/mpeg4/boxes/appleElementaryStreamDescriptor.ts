...
export default class AppleElementaryStreamDescriptor extends FullBox {
	 ...
	 */
	public static fromFile(header: Mpeg4BoxHeader, file: File, handlerType: ByteVector): AppleElementaryStreamDescriptor {
	 ...
	 */
	public get dependsOnEsId(): number {
		return this._dependsOnEsId;
	}
	 ...
	 * Gets the OCR ES_ID
	 */
	public get ocrEsId(): number {
		return this._ocrEsId;
	}

	/**
	 * Gets the OCR Stream Flag
	 */
	public get ocrStreamFlag(): boolean {
		return this._ocrStreamFlag;
	}

	/**
	 * Gets a value indicating that a dependsOn_ES_ID will follow
	 */
	public get streamDependenceFlag(): boolean {
		return this._streamDependenceFlag;
	}
