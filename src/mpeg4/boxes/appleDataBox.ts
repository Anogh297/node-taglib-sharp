...
export class AppleDataBox extends FullBox {
	...
	public get text(): string {
		return NumberUtils.hasFlag(this.flags, AppleDataBoxFlagType.ContainsText) ? this.data.toString(StringType.UTF8) : undefined;
	}
	/**
	...
	public renderBoxHeaders(): ByteVector[] {
		return [...super.renderBoxHeaders(), ByteVector.fromSize(4)];
	}
}
