...
export default class Mpeg4BoxHeader {
	...
	public render(): ByteVector {
		...
		const boxSizeValue = this._headerSize === 8 || this._headerSize === 24 ? this._boxSize : 1;
		const extendedSize = this._headerSize === 16 || this._headerSize === 32 ? ByteVector.fromUlong(this._boxSize) : undefined;
		const extendedType = this.headerSize > 24 ? this._extendedType : undefined;
