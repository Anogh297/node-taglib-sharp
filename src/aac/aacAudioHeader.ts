...
export default class AacAudioHeader implements IAudioCodec {
	private static readonly SAMPLE_RATES = [96000, 88200, 64000, 48000, 44100, 32000, 24000, 22050, 16000, 12000, 11025, 8000, 7350];
	 ...
	 */
	public constructor(channels: number, bitrate: number, sampleRate: number, mpegAudioType: number) {
	...
	public get description(): string {
		return `ADTS AAC: ${Mpeg4AudioTypes[this._mpeg4AudioTypeIndex]}`;
	}
