...
export default abstract class CombinedTag extends Tag {
	 ...
	 */
	public get supportedTagTypes(): TagTypes {
		return this._supportedTagTypes;
	}
	...
	public get title(): string {
		return this.getFirstValue((t) => t.title);
	}
	/** @inheritDoc */
	...
	public get titleSort(): string {
		return this.getFirstValue((t) => t.titleSort);
	}
	/** @inheritDoc */
	public set titleSort(val: string) {
		this.setValues((t, v) => {
			t.titleSort = v;
		}, val);
	}
	...
	public get subtitle(): string {
		return this.getFirstValue((t) => t.subtitle);
	}
	/** @inheritDoc */
	...
	public get description(): string {
		return this.getFirstValue((t) => t.description);
	}
	/** @inheritDoc */
	...
	public get performers(): string[] {
		return this.getFirstArray((t) => t.performers);
	}
	/** @inheritDoc */
	public set performers(val: string[]) {
		this.setValues((t, v) => {
			t.performers = v;
		}, val);
	}
	...
	public get performersSort(): string[] {
		return this.getFirstArray((t) => t.performersSort);
	}
	/** @inheritDoc */
	public set performersSort(val: string[]) {
		this.setValues((t, v) => {
			t.performersSort = v;
		}, val);
	}
	...
	public get performersRole(): string[] {
		return this.getFirstArray((t) => t.performersRole);
	}
	/** @inheritDoc */
	public set performersRole(val: string[]) {
		this.setValues((t, v) => {
			t.performersRole = v;
		}, val);
	}
	...
	public get albumArtists(): string[] {
		return this.getFirstArray((t) => t.albumArtists);
	}
	/** @inheritDoc */
	public set albumArtists(val: string[]) {
		this.setValues((t, v) => {
			t.albumArtists = v;
		}, val);
	}
	...
	public get albumArtistsSort(): string[] {
		return this.getFirstArray((t) => t.albumArtistsSort);
	}
	/** @inheritDoc */
	public set albumArtistsSort(val: string[]) {
		this.setValues((t, v) => {
			t.albumArtistsSort = v;
		}, val);
	}

	/** @inheritDoc */
	public get composers(): string[] {
		return this.getFirstArray((t) => t.composers);
	}
	/** @inheritDoc */
	public set composers(val: string[]) {
		this.setValues((t, v) => {
			t.composers = v;
		}, val);
	}
	...
	public get composersSort(): string[] {
		return this.getFirstArray((t) => t.composersSort);
	}
	/** @inheritDoc */
	public set composersSort(val: string[]) {
		this.setValues((t, v) => {
			t.composersSort = v;
		}, val);
	}
	...
	public get album(): string {
		return this.getFirstValue((t) => t.album);
	}
	/** @inheritDoc */
	public set album(val: string) {
		this.setValues((t, v) => {
			t.album = v;
		}, val);
	}
	...
	public get albumSort(): string {
		return this.getFirstValue((t) => t.albumSort);
	}
	/** @inheritDoc */
	public set albumSort(val: string) {
		this.setValues((t, v) => {
			t.albumSort = v;
		}, val);
	}
	...
	public get comment(): string {
		return this.getFirstValue((t) => t.comment);
	}
	/** @inheritDoc */
	...
	public get genres(): string[] {
		return this.getFirstArray((t) => t.genres);
	}
	/** @inheritDoc */
	public set genres(val: string[]) {
		this.setValues((t, v) => {
			t.genres = v;
		}, val);
	}
	...
	public get year(): number {
		return this.getFirstValue((t) => t.year, 0);
	}
	/** @inheritDoc */
	...
	public get track(): number {
		return this.getFirstValue((t) => t.track, 0);
	}
	/** @inheritDoc */
	public set track(val: number) {
		this.setUint((t, v) => {
			t.track = v;
		}, val);
	}
	...
	public get trackCount(): number {
		return this.getFirstValue((t) => t.trackCount, 0);
	}
	/** @inheritDoc */
	public set trackCount(val: number) {
		this.setUint((t, v) => {
			t.trackCount = v;
		}, val);
	}
	...
	public get disc(): number {
		return this.getFirstValue((t) => t.disc, 0);
	}
	/** @inheritDoc */
	public set disc(val: number) {
		this.setUint((t, v) => {
			t.disc = v;
		}, val);
	}
	...
	public get discCount(): number {
		return this.getFirstValue((t) => t.discCount, 0);
	}
	/** @inheritDoc */
	public set discCount(val: number) {
		this.setUint((t, v) => {
			t.discCount = v;
		}, val);
	}
	...
	public get lyrics(): string {
		return this.getFirstValue((t) => t.lyrics);
	}
	/** @inheritDoc */
	public set lyrics(val: string) {
		this.setValues((t, v) => {
			t.lyrics = v;
		}, val);
	}
	...
	public get grouping(): string {
		return this.getFirstValue((t) => t.grouping);
	}
	/** @inheritDoc */
	public set grouping(val: string) {
		this.setValues((t, v) => {
			t.grouping = v;
		}, val);
	}
	...
	public get beatsPerMinute(): number {
		return this.getFirstValue((t) => t.beatsPerMinute, 0);
	}
	/** @inheritDoc */
	public set beatsPerMinute(val: number) {
		this.setUint((t, v) => {
			t.beatsPerMinute = v;
		}, val);
	}
	...
	public get conductor(): string {
		return this.getFirstValue((t) => t.conductor);
	}
	/** @inheritDoc */
	public set conductor(val: string) {
		this.setValues((t, v) => {
			t.conductor = v;
		}, val);
	}
	...
	public get copyright(): string {
		return this.getFirstValue((t) => t.copyright);
	}
	/** @inheritDoc */
	public set copyright(val: string) {
		this.setValues((t, v) => {
			t.copyright = v;
		}, val);
	}
	...
	public get dateTagged(): Date {
		return this.getFirstValue((t) => t.dateTagged);
	}
	/** @inheritDoc */
	public set dateTagged(val: Date) {
		this.setValues((t, v) => {
			t.dateTagged = v;
		}, val);
	}
	...
	public get musicBrainzArtistId(): string {
		return this.getFirstValue((t) => t.musicBrainzArtistId);
	}
	/** @inheritDoc */
	public set musicBrainzArtistId(val: string) {
		this.setValues((t, v) => {
			t.musicBrainzArtistId = v;
		}, val);
	}
	...
	/** @inheritDoc */
	public set musicBrainzReleaseId(val: string) {
		this.setValues((t, v) => {
			t.musicBrainzReleaseId = v;
		}, val);
	}
	...
	public set musicBrainzReleaseArtistId(val: string) {
		this.setValues((t, v) => {
			t.musicBrainzReleaseArtistId = v;
		}, val);
	}
	...
	/** @inheritDoc */
	public set musicBrainzTrackId(val: string) {
		this.setValues((t, v) => {
	...
	/** @inheritDoc */
	public set musicBrainzDiscId(val: string) {
		this.setValues((t, v) => {
			t.musicBrainzDiscId = v;
		}, val);
	}

	/** @inheritDoc */
	public get musicIpId(): string {
		return this.getFirstValue((t) => t.musicIpId);
	}
	/** @inheritDoc */
	public set musicIpId(val: string) {
		this.setValues((t, v) => {
			t.musicIpId = v;
		}, val);
	}
	...
	public get amazonId(): string {
		return this.getFirstValue((t) => t.amazonId);
	}
	/** @inheritDoc */
	public set amazonId(val: string) {
		this.setValues((t, v) => {
			t.amazonId = v;
		}, val);
	}
	...
	public set musicBrainzReleaseCountry(val: string) {
		this.setValues((t, v) => {
			t.musicBrainzReleaseCountry = v;
		}, val);
	}

	/** @inheritDoc */
	public get replayGainTrackGain(): number {
		return this.getFirstValue((t) => t.replayGainTrackGain, NaN);
	}
	/** @inheritDoc */
	public set replayGainTrackGain(val: number) {
		this.setValues((t, v) => {
			t.replayGainTrackGain = v;
		}, val);
	}

	/** @inheritDoc */
	public get replayGainTrackPeak(): number {
		return this.getFirstValue((t) => t.replayGainTrackPeak, NaN);
	}
	/** @inheritDoc */
	public set replayGainTrackPeak(val: number) {
		this.setValues((t, v) => {
			t.replayGainTrackPeak = v;
		}, val);
	}

	/** @inheritDoc */
	public get replayGainAlbumGain(): number {
		return this.getFirstValue((t) => t.replayGainAlbumGain, NaN);
	}
	/** @inheritDoc */
	public set replayGainAlbumGain(val: number) {
		this.setValues((t, v) => {
			t.replayGainAlbumGain = v;
		}, val);
	}

	/** @inheritDoc */
	public get replayGainAlbumPeak(): number {
		return this.getFirstValue((t) => t.replayGainAlbumPeak, NaN);
	}
	/** @inheritDoc */
	public set replayGainAlbumPeak(val: number) {
		this.setValues((t, v) => {
			t.replayGainAlbumPeak = v;
		}, val);
	}

	/** @inheritDoc */
	public get initialKey(): string {
		return this.getFirstValue((t) => t.initialKey);
	}
	/** @inheritDoc */
	public set initialKey(val: string) {
		this.setValues((t, v) => {
			t.initialKey = v;
		}, val);
	}
	...
	public get remixedBy(): string {
		return this.getFirstValue((t) => t.remixedBy);
	}
	/** @inheritDoc */
	public set remixedBy(val: string) {
		this.setValues((t, v) => {
			t.remixedBy = v;
		}, val);
	}
	...
	public get publisher(): string {
		return this.getFirstValue((t) => t.publisher);
	}
	/** @inheritDoc */
	public set publisher(val: string) {
		this.setValues((t, v) => {
			t.publisher = v;
		}, val);
	}
	...
	public get isrc(): string {
		return this.getFirstValue((t) => t.isrc);
	}
	/** @inheritDoc */
	public set isrc(val: string) {
		this.setValues((t, v) => {
			t.isrc = v;
		}, val);
	}
	...
	public get pictures(): IPicture[] {
		return this.getFirstArray((t) => t.pictures);
	}
	/** @inheritDoc */
	public set pictures(val: IPicture[]) {
		this.setValues((t, v) => {
			t.pictures = v;
		}, val);
	}
	...
	public get isCompilation(): boolean {
		return this.getFirstValue((t) => t.isCompilation);
	}
	/** @inheritDoc */
	public set isCompilation(val: boolean) {
		this.setValues((t, v) => {
			t.isCompilation = v;
		}, val);
	}
