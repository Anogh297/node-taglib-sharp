...
export default class XiphComment extends Tag {
	...
	public get title(): string {
		return this.getFieldFirstValue("TITLE");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TITLE` field
	...
	public set title(value: string) {
		this.setFieldAsStrings("TITLE", value);
	}
	...
	public get titleSort(): string {
		return this.getFieldFirstValue("TITLESORT");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `TITLESORT` field
	...
	public set titleSort(value: string) {
		this.setFieldAsStrings("TITLESORT", value);
	}
	...
	public get subtitle(): string {
		return this.getFieldFirstValue("SUBTITLE");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `SUBTITLE` field
	...
	public set subtitle(value: string) {
		this.setFieldAsStrings("SUBTITLE", value);
	}
	...
	public get description(): string {
		return this.getFieldFirstValue("DESCRIPTION");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `DESCRIPTION` field
	...
	public set description(value: string) {
		this.setFieldAsStrings("DESCRIPTION", value);
	}
	...
	public set performers(value: string[]) {
		this.setFieldAsStrings("ARTIST", ...value);
	}
	...
	public set performersSort(value: string[]) {
		this.setFieldAsStrings("ARTISTSORT", ...value);
	}
	...
	public get performersRole(): string[] {
		return this.getField("ARTISTROLE");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `ARTISTROLE` field
	...
	public set performersRole(value: string[]) {
		this.setFieldAsStrings("ARTISTROLE", ...value);
	}
	...
	public set albumArtistsSort(value: string[]) {
		this.setFieldAsStrings("ALBUMARTISTSORT", ...value);
	}
	...
	public set composers(value: string[]) {
		this.setFieldAsStrings("COMPOSER", ...value);
	}
	...
	public set composersSort(value: string[]) {
		this.setFieldAsStrings("COMPOSERSORT", ...value);
	}
	...
	public get album(): string {
		return this.getFieldFirstValue("ALBUM");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `ALBUM` field
	...
	public set album(value: string) {
		this.setFieldAsStrings("ALBUM", value);
	}
	...
	public get albumSort(): string {
		return this.getFieldFirstValue("ALBUMSORT");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `ALBUMSORT` field
	...
	public set albumSort(value: string) {
		this.setFieldAsStrings("ALBUMSORT", value);
	}
	...
	public get comment(): string {
		return this.getFieldFirstValue("COMMENT");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `COMMENT` field
	...
	public set comment(value: string) {
		this.setFieldAsStrings("COMMENT", value);
	}
	...
	public set genres(value: string[]) {
		this.setFieldAsStrings("GENRE", ...value);
	}
	...
	public get lyrics(): string {
		return this.getFieldFirstValue("LYRICS");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `LYRICS` field
	...
	public set lyrics(value: string) {
		this.setFieldAsStrings("LYRICS", value);
	}
	...
	public get grouping(): string {
		return this.getFieldFirstValue("GROUPING");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `GROUPING` field
	...
	public set grouping(value: string) {
		this.setFieldAsStrings("GROUPING", value);
	}
	...
	public get conductor(): string {
		return this.getFieldFirstValue("CONDUCTOR");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `CONDUCTOR` field
	...
	public set conductor(value: string) {
		this.setFieldAsStrings("CONDUCTOR", value);
	}
	...
	public get copyright(): string {
		return this.getFieldFirstValue("COPYRIGHT");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `GROUPING` field
	...
	public set copyright(value: string) {
		this.setFieldAsStrings("COPYRIGHT", value);
	}
	...
	public get musicBrainzArtistId(): string {
		return this.getFieldFirstValue("MUSICBRAINZ_ARTISTID");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MUSICBRAINZ_ARTISTID` field
	...
	public set musicBrainzArtistId(value: string) {
		this.setFieldAsStrings("MUSICBRAINZ_ARTISTID", value);
	}
	...
	public get musicBrainzReleaseGroupId(): string {
		return this.getFieldFirstValue("MUSICBRAINZ_RELEASEGROUPID");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MUSICBRAINZ_RELEASEGROUPID` field
	...
	public set musicBrainzReleaseGroupId(value: string) {
		this.setFieldAsStrings("MUSICBRAINZ_RELEASEGROUPID", value);
	}
	...
	public get musicBrainzReleaseId(): string {
		return this.getFieldFirstValue("MUSICBRAINZ_ALBUMID");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MUSICBRAINZ_ALBUMID` field
	...
	public set musicBrainzReleaseId(value: string) {
		this.setFieldAsStrings("MUSICBRAINZ_ALBUMID", value);
	}
	...
	public get musicBrainzReleaseArtistId(): string {
		return this.getFieldFirstValue("MUSICBRAINZ_ALBUMARTISTID");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MUSICBRAINZ_ALBUMARTISTID` field
	...
	public set musicBrainzReleaseArtistId(value: string) {
		this.setFieldAsStrings("MUSICBRAINZ_ALBUMARTISTID", value);
	}
	...
	public get musicBrainzTrackId(): string {
		return this.getFieldFirstValue("MUSICBRAINZ_TRACKID");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MUSICBRAINZ_TRACKID` field
	...
	public set musicBrainzTrackId(value: string) {
		this.setFieldAsStrings("MUSICBRAINZ_TRACKID", value);
	}
	...
	public get musicBrainzDiscId(): string {
		return this.getFieldFirstValue("MUSICBRAINZ_DISCID");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MUSICBRAINZ_DISCID` field
	...
	public set musicBrainzDiscId(value: string) {
		this.setFieldAsStrings("MUSICBRAINZ_DISCID", value);
	}
	...
	public get musicIpId(): string {
		return this.getFieldFirstValue("MUSICIP_PUID");
	}
	/**
	 * @inheritDoc
	...
	public set musicIpId(value: string) {
		this.setFieldAsStrings("MUSICIP_PUID", value);
	}
	...
	public get amazonId(): string {
		return this.getFieldFirstValue("ASIN");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `ASIN` field
	...
	public set amazonId(value: string) {
		this.setFieldAsStrings("ASIN", value);
	}
	...
	public get musicBrainzReleaseStatus(): string {
		return this.getFieldFirstValue("MUSICBRAINZ_ALBUMSTATUS");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MUSICBRAINZ_ALBUMSTATUS` field
	...
	public set musicBrainzReleaseStatus(value: string) {
		this.setFieldAsStrings("MUSICBRAINZ_ALBUMSTATUS", value);
	}
	...
	public get musicBrainzReleaseType(): string {
		return this.getFieldFirstValue("MUSICBRAINZ_ALBUMTYPE");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `MUSICBRAINZ_ALBUMTYPE` field
	...
	public set musicBrainzReleaseType(value: string) {
		this.setFieldAsStrings("MUSICBRAINZ_ALBUMTYPE", value);
	}
	...
	public get musicBrainzReleaseCountry(): string {
		return this.getFieldFirstValue("RELEASECOUNTRY");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `RELEASECOUNTRY` field
	...
	public set musicBrainzReleaseCountry(value: string) {
		this.setFieldAsStrings("RELEASECOUNTRY", value);
	}
	...
	public get isCompilation(): boolean {
		return this.getFieldFirstValue("COMPILATION") === "1";
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `COMPILATION` field
	...
	public get initialKey(): string {
		return this.getFieldFirstValue("INITIALKEY");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `INITIALKEY` field
	...
	public set initialKey(value: string) {
		this.setFieldAsStrings("INITIALKEY", value);
	}
	...
	public get remixedBy(): string {
		return this.getFieldFirstValue("REMIXEDBY");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `REMIXEDBY` field
	...
	public set remixedBy(value: string) {
		this.setFieldAsStrings("REMIXEDBY", value);
	}
	...
	public get publisher(): string {
		return this.getFieldFirstValue("ORGANIZATION");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `ORGANIZATION` field
	...
	public set publisher(value: string) {
		this.setFieldAsStrings("ORGANIZATION", value);
	}
	...
	public get isrc(): string {
		return this.getFieldFirstValue("ISRC");
	}
	/**
	 * @inheritDoc
	 * @remarks Stored in the `ISRC` field
	...
	public set isrc(value: string) {
		this.setFieldAsStrings("ISRC", value);
	}
	...
	public render(addFramingBit: boolean): ByteVector {
		...
		const allFieldData = this.fieldNames.reduce<ByteVector[]>((a, k) => {
			const fieldData = this._fields.get(k).map((v) => {
				...
				return ByteVector.concatenate(ByteVector.fromUint(fieldDatum.length, false), fieldDatum);
			});
			a.push(...fieldData);
		...
		const pictureData = this._pictures.map((p) => {
			...
			return ByteVector.concatenate(ByteVector.fromUint(encodedPicture.length, false), ByteVector.fromString(encodedPicture, StringType.UTF8));
		});
	...
	private static isPictureField(fieldName: string): boolean {
		return fieldName === XiphComment.OLD_PICTURE_FIELD || fieldName === XiphComment.NEW_PICTURE_FIELD;
	}
