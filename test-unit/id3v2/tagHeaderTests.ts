...
const getTestHeader = (majorVersion: number, minorVersion: number, flags: Id3v2TagHeaderFlags): Id3v2TagHeader => {
	const data = ByteVector.concatenate(Id3v2TagHeader.FILE_IDENTIFIER, majorVersion, minorVersion, flags, 0x10, 0x10, 0x10, 0x10);
...
class Id3v2_TagHeader_ConstructorTests {
	...
	public invalidFlagsForVersion2() {
		// Arrange
		const testData = ByteVector.concatenate(Id3v2TagHeader.FILE_IDENTIFIER, 0x02, 0x00, 0xff, 0x00, 0x00, 0x00, 0x00);
	...
	public invalidFlagsForVersion3() {
		// Arrange
		const testData = ByteVector.concatenate(Id3v2TagHeader.FILE_IDENTIFIER, 0x03, 0x00, 0xff, 0x00, 0x00, 0x00, 0x00);
	...
	public invalidFlagsForVersion4() {
		// Arrange
		const testData = ByteVector.concatenate(Id3v2TagHeader.FILE_IDENTIFIER, 0x04, 0x00, 0xff, 0x00, 0x00, 0x00, 0x00);
	...
	public invalidTagSizeBytes() {
		// Arrange
		const testData = ByteVector.concatenate(Id3v2TagHeader.FILE_IDENTIFIER, 0x04, 0x00, 0x00);
	...
	public validData() {
		...
		const flags = 0xe0;
		const testData = ByteVector.concatenate(Id3v2TagHeader.FILE_IDENTIFIER, majorVersion, minorVersion, flags, 0x10, 0x10, 0x10, 0x10);
...
class Id3v2_TagHeader_PropertyTests {
	...
	public setFlags_version2InvalidFlags() {
		...
		// Act
		const set1 = () => {
			header.flags = Id3v2TagHeaderFlags.ExtendedHeader;
		};
		const set2 = () => {
			header.flags = Id3v2TagHeaderFlags.ExperimentalIndicator;
		};
		const set3 = () => {
	...
	public setMajorVersion_2_unsets3And4Flags() {
		// Arrange
		const flags = Id3v2TagHeaderFlags.ExtendedHeader | Id3v2TagHeaderFlags.ExperimentalIndicator | Id3v2TagHeaderFlags.FooterPresent;
