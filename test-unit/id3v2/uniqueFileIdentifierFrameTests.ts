...
class Id3v2_UniqueFileIdentifierFrame_ConstructorTests extends FrameConstructorTests {
	...
	public fromData_invalidOwner_throws() {
		...
		Testers.testTruthy((v: string) => {
			UniqueFileIdentifierFrame.fromData(v, identifier);
		});
	}
	...
	public fromData_invalidIdentifier_throws() {
		...
		// Act/Assert
		assert.throws(() => {
			UniqueFileIdentifierFrame.fromData(owner, ByteVector.fromSize(65));
		});
	}
	...
	public fromOffsetRawData_tooFewFields_returnsEmptyFrame() {
		...
		header.frameSize = 9;
		const data = ByteVector.concatenate(header.render(4), 0x0, 0x0, testIdentifier);
	...
	public fromRawData_tooFewFields_returnsEmptyFrame() {
		...
		const header = new Id3v2FrameHeader(FrameIdentifiers.UFID);
		header.frameSize = 9;
		const data = ByteVector.concatenate(header.render(4), testIdentifier);
...
class Id3v2_UniqueFileIdentifierFrame_PropertyTests {
	...
	public setIdentifier_tooLong_throws() {
		...
		// Act/Assert
		PropertyTests.propertyThrows((v) => {
			frame.identifier = v;
		}, ByteVector.fromSize(65));
	}
...
class Id3v2_UniqueFileIdentifierFrame_MethodTests {
	...
	public find_falsyFrames_throws() {
		// Act/Assert
		Testers.testTruthy((v: UniqueFileIdentifierFrame[]) => {
			UniqueFileIdentifierFrame.find(v, "fux");
		});
	}
