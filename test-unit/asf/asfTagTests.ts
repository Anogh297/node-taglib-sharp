...
class Asf_Tag_PropertyTests {
	...
	private testContentDescriptorArray(set: (t: AsfTag, v: string[]) => void, get: (t: AsfTag) => string[], cdProperty: (cd: ContentDescriptionObject) => string) {
		// Arrange
		const tag = AsfTag.fromEmpty();
	...
	private testContentDescriptorField(set: (t: AsfTag, v: string) => void, get: (t: AsfTag) => string, cdProperty: (cd: ContentDescriptionObject) => string) {
		// Arrange
		const tag = AsfTag.fromEmpty();
		const setProp = (v: string) => set(tag, v);
		const getProp = () => get(tag);
	...
	private testExtendedDescriptionObjectStringArray(set: (t: AsfTag, v: string[]) => void, get: (t: AsfTag) => string[], ...descriptorName: string[]) {
	...
	private testExtendedDescriptionObjectStringField(set: (t: AsfTag, v: string) => void, get: (t: AsfTag) => string, ...descriptorName: string[]) {
		// TEST CASE 1: Basic Case -----------------------------------------
		// Arrange
		const tag = AsfTag.fromEmpty();
		const setProp = (v: string) => set(tag, v);
