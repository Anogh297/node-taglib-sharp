...
@suite
class Asf_MetadataDescriptorTests {
	@test
...
@suite
class MetadataLibraryObjectTests extends ObjectTests<MetadataLibraryObject> {
	...
	public addRecords_falsyRecord() {
		...
		// Act / Assert
		Testers.testTruthy((v: MetadataDescriptor) => {
			object.addRecord(v);
		});
	}
	...
	public setRecords_noMatches() {
		...
		// Assert
		assert.sameMembers(object.records, [descriptor1, descriptor2, descriptor3, descriptor4, newDescriptor1, newDescriptor2]);
	}
}
