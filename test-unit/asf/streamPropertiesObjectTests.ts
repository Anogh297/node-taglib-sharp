...
@suite
class Asf_StreamPropertiesObjectTests extends ObjectTests<StreamPropertiesObject> {
	...
	protected get objectGuid(): UuidWrapper {
		return Guids.ASF_STREAM_PROPERTIES_OBJECT;
	}
	...
	private _originalSize = 16 + 8 + 16 + 16 + 8 + 4 + 4 + 2 + 4 + this._errorCorrectionData.length + this._typeSpecificData.length;
