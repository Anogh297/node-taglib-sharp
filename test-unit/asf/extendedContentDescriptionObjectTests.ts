...
@suite
class Asf_ContentDescriptorTests {
...
@suite
class Asf_ExtendedContentDescriptionObjectTests extends ObjectTests<ExtendedContentDescriptionObject> {
	...
	protected get objectGuid(): UuidWrapper {
		return Guids.ASF_METADATA_LIBRARY_OBJECT;
	}
	...
	public addDescriptors_falsyRecord() {
		...
		// Act / Assert
		Testers.testTruthy((v: ContentDescriptor) => {
			object.addDescriptor(v);
		});
	}
	...
	public setDescriptors_noMatches() {
		...
		// Assert
		assert.sameMembers(object.descriptors, [descriptor1, descriptor2, descriptor3, descriptor4, newDescriptor1, newDescriptor2]);
	}
}
