...
class Riff_RiffListTagTests {
	...
	public getValueAsStrings_keyExists() {
		...
		list.setValues("TXT1", [ByteVector.fromString("foobar", StringType.UTF16BE), ByteVector.fromString("fuxbux", StringType.UTF16BE), ByteVector.empty()]);
