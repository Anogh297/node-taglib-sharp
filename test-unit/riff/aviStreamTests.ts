...
class Riff_AviStreamTest {
	...
	public constructor_audioStream() {
		...
		list.setValues("strf", [ByteVector.concatenate(ByteVector.fromUshort(0xbbbb), ByteVector.fromSize(14))]);
	...
	public constructor_videoStream() {
		...
		list.setValues("strf", [ByteVector.concatenate(ByteVector.fromSize(16), ByteVector.fromString("fooo", StringType.UTF8), ByteVector.fromSize(20))]);
