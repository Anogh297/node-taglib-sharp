...
class Matroska_TagTargetTests {
	...
	public fromTargetElement_valid() {
		...
		const bytes = [
			0x68,
			0xca, // Identifier (TARGET_TYPE_VALUE)
			0x81, // Size (1)
			0x46, // Value (0x46)

			0x63,
			0xca, // Identifier (TARGET_TYPE)
			0x83, // Size (3)
			0x41,
			0x42,
			0x43, // Value (ABC)
			...
			0x63,
			0xc9, // Identifier (TAG_EDITION_UID)
			0x88, // Size (8)
			0x03,
			0x04,
			0x05,
			...
			0x63,
			0xc4, // Identifier (TAG_CHAPTER_UID)
			0x88, // Size (8)
			0x05,
			0x06,
			0x07,
			...
			0x63,
			0xc6, // Identifier (TAG_ATTACHMENT_UID)
			0x88, // Size (8)
			0x07,
			0x08,
			0x09,
