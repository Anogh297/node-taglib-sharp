...
@suite
class ByteVector_MethodTests {
	private readonly vectorToAdd: ByteVector = ByteVector.fromByteArray(new Uint8Array([0xaa, 0xbb]));
	...
	public addByteVector_addViewToMultiple() {
		...
		const bv = ByteVector.fromSize(1);
		const ba = bv["_bytes"];
		const add = ByteVector.fromByteArray([0xaa, 0x01, 0x02, 0xaa]).subarray(1, 2);
	...
	public containsAt_doesNotContainInView() {
		const bv = ByteVector.fromString("0foobarbaz0", StringType.Latin1).subarray(1, 9);
		const pattern = ByteVector.fromString("qux", StringType.Latin1);
	...
	public compare_viewToConcrete() {
		// Arrange
		const bv = ByteVector.concatenate(0xaa, 0x00, 0x05, 0xaa).subarray(1, 2);
		const other = ByteVector.concatenate(0x00, 0x04);
	...
	public compare_concreteToView() {
		// Arrange
		const bv = ByteVector.concatenate(0x00, 0x05);
		const other = ByteVector.concatenate(0xaa, 0x00, 0x04, 0xaa).subarray(1, 2);
	...
	public endsWith_endsWithView() {
		// Arrange
		const bv = ByteVector.fromString("foobarbaz", StringType.Latin1);
		const pattern = ByteVector.fromString("0baz0", StringType.Latin1).subarray(1, 3);
	...
	public endsWith_doesNotEndWithView() {
		// Arrange
		const bv = ByteVector.fromString("foobarbaz", StringType.Latin1);
		const pattern = ByteVector.fromString("0qux0", StringType.Latin1).subarray(1, 3);
	...
	public endsWith_viewDoesNotEndWithView() {
		// Arrange
		const bv = ByteVector.fromString("0foobarbaz0", StringType.Latin1).subarray(1, 9);
		const pattern = ByteVector.fromString("0bux0", StringType.Latin1).subarray(1, 3);
	...
	public endsWithPartialMatch_endsWithPartialView() {
		// Arrange
		const bv = ByteVector.fromString("foobarbaz", StringType.Latin1);
		const pattern = ByteVector.fromString("0bazqqq0", StringType.Latin1).subarray(1, 6);
	...
	public equals_concreteEqualsView() {
		// Arrange
		const bv1 = ByteVector.fromByteArray([0x01, 0x02]);
		const bv2 = ByteVector.fromByteArray([0xaa, 0x01, 0x02, 0xaa]).subarray(1, 2);
	...
	public equals_viewEqualsConcrete() {
		// Arrange
		const bv1 = ByteVector.fromByteArray([0xaa, 0x01, 0x02, 0xaa]).subarray(1, 2);
		const bv2 = ByteVector.fromByteArray([0x01, 0x02]);
	...
	public equals_concreteDoesNotEqualView() {
		// Arrange
		const bv1 = ByteVector.fromByteArray([0x01, 0x02]);
		const bv2 = ByteVector.fromByteArray([0xaa, 0x03, 0x04, 0xaa]).subarray(1, 2);
	...
	public find_concreteInView() {
		// Arrange
		const bv = ByteVector.fromString("foobarbaz", StringType.Latin1);
		const pattern = ByteVector.fromString("0bar0", StringType.Latin1).subarray(1, 3);
	...
	public find_multibyteInViewWithAlign() {
		// Arrange
		const bv = ByteVector.fromString("000abc0", StringType.Latin1).subarray(1, 5);
		const pattern = ByteVector.fromString("ab", StringType.Latin1);
	...
	public get_validParameterView() {
		// Arrange
		const bv = ByteVector.fromByteArray([0xaa, 1, 2, 3, 0xaa]).subarray(1, 3);
	...
	public offsetFind_multibyteInViewWithAlign() {
		// Arrange
		const bv = ByteVector.fromString("0000abc0", StringType.Latin1).subarray(1, 5);
		const pattern = ByteVector.fromString("ab", StringType.Latin1);
	...
	public resize_lengthenView() {
		// Arrange
		const bv = ByteVector.fromByteArray([0xaa, 0x00, 0x01, 0x02, 0x03, 0xaa]).subarray(1, 4);
	...
	public set_view() {
		// Arrange
		const bv = ByteVector.fromByteArray([0xaa, 0x00, 0x01, 0x02, 0xaa]).subarray(1, 3);
	...
	public splice_insertByte_insertIntoView() {
		// Arrange
		const bv = ByteVector.fromByteArray([0x11, 0x01, 0x02, 0x03, 0x04, 0x11]).subarray(1, 4);
	...
	public splice_insertByteVectorView_insertInMiddle() {
		// Arrange
		const bv = ByteVector.fromByteArray([0x01, 0x02, 0x03, 0x04]);
		const add = ByteVector.fromByteArray([0x11, 0xaa, 0xbb, 0x11]).subarray(1, 2);
	...
	public splice_removeRange_tooManyBytesView() {
		// Arrange
		const bv = ByteVector.fromSize(3, 0x00).subarray(1, 1);
	...
	public splice_removeRange_removeFromFrontView() {
		// Arrange
		const bv = ByteVector.fromByteArray([0x11, 0xaa, 0xbb, 0x00, 0x01, 0x02, 0x03, 0x11]).subarray(1, 6);
	...
	public splice_removeRange_removeFromBackView() {
		// Arrange
		const bv = ByteVector.fromByteArray([0x11, 0x00, 0x01, 0x02, 0x03, 0xaa, 0xbb, 0x11]).subarray(1, 6);
	...
	public splice_removeRange_removeFromMiddleView() {
		// Arrange
		const bv = ByteVector.fromByteArray([0x11, 0x00, 0x01, 0xaa, 0xbb, 0x02, 0x03, 0x11]).subarray(1, 6);
	...
	public split_multiByteWithByteAlignOnView_noMatch() {
		// Arrange
		const bv = ByteVector.fromString("Afoo,,barA", StringType.Latin1).subarray(1, 8);
		const pattern = ByteVector.fromString(",,", StringType.Latin1);
	...
	public split_multiByteViewWithByteAlign_noMatch() {
		// Arrange
		const bv = ByteVector.fromString("foo,,bar", StringType.Latin1);
		const pattern = ByteVector.fromString("0,,0", StringType.Latin1).subarray(1, 2);
	...
	public split_multiByteWithByteAlignOnView_match() {
		// Arrange
		const bv = ByteVector.fromString(" 0foo,,bar ", StringType.Latin1).subarray(1, 9);
		const pattern = ByteVector.fromString(",,", StringType.Latin1);
	...
	public split_multiByteViewWithByteAlign_match() {
		// Arrange
		const bv = ByteVector.fromString("0foo,,bar", StringType.Latin1);
		const pattern = ByteVector.fromString(" ,, ", StringType.Latin1).subarray(1, 2);
	...
	public startsWith_startsWithView() {
		// Arrange
		const bv = ByteVector.fromString("foobarbaz", StringType.Latin1);
		const pattern = ByteVector.fromString("0foo0", StringType.Latin1).subarray(1, 3);
	...
	public startsWith_doesNotStartsWithView() {
		// Arrange
		const bv = ByteVector.fromString("foobarbaz", StringType.Latin1);
		const pattern = ByteVector.fromString("0fux0", StringType.Latin1).subarray(1, 3);
