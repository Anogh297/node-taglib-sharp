...
class Ape_StreamHeaderTests {
	...
	public constructor_wrongIdentifier() {
		// Arrange
		const data = ByteVector.concatenate(ByteVector.fromString("ID3", StringType.Latin1), ByteVector.fromSize(73));
	...
	public constructor_tooShort() {
		// Arrange
		const data = ByteVector.concatenate(ByteVector.fromString("MAC ", StringType.Latin1), ByteVector.fromSize(10));
