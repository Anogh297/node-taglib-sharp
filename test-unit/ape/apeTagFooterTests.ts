...
@suite
class Ape_TagFooter_ConstructorTests {
	@test
...
@suite
class Ape_TagFooter_PropertyTests {
	@test
...
@suite
class Ape_TagFooter_MethodTests {
	@test
