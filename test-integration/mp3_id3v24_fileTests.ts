...
class Mp3_id3v24_fileTests {
	...
	public readTags() {
		...
		assert.deepStrictEqual(Mp3_id3v24_fileTests.file.tag.performers, ["MP3 artist unicode (\u1283\u12ed\u120c \u1308\u1265\u1228\u1225\u120b\u1234)"]);
		assert.deepStrictEqual(Mp3_id3v24_fileTests.file.tag.genres, ["Acid Punk"]);
		assert.deepStrictEqual(Mp3_id3v24_fileTests.file.tag.composers, ["MP3 composer"]);
	}
	...
	public urlLinkFrameTest() {
		...
		const testToPerform = () => {
			...
			try {
				...
				assert.strictEqual(id3v2Tag2.getTextAsString(Id3v2FrameIdentifiers.WCOM), "www.commercial.com");
				assert.strictEqual(id3v2Tag2.getTextAsString(Id3v2FrameIdentifiers.WCOP), "www.copyright.com");
				assert.strictEqual(id3v2Tag2.getTextAsString(Id3v2FrameIdentifiers.WOAF), "www.official-audio.com");
				assert.strictEqual(id3v2Tag2.getTextAsString(Id3v2FrameIdentifiers.WOAR), "www.official-artist.com");
				assert.strictEqual(id3v2Tag2.getTextAsString(Id3v2FrameIdentifiers.WOAS), "www.official-audio-source.com");
				assert.strictEqual(id3v2Tag2.getTextAsString(Id3v2FrameIdentifiers.WORS), "www.official-internet-radio.com");
				assert.strictEqual(id3v2Tag2.getTextAsString(Id3v2FrameIdentifiers.WPAY), "www.payment.com");
				assert.strictEqual(id3v2Tag2.getTextAsString(Id3v2FrameIdentifiers.WPUB), "www.official-publisher.com");
			} finally {
				urlLinkFile.dispose();
			}
		};
